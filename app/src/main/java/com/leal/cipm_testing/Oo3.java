    ...
    public void GenPresPerf2() {
        switch (neg) {
            ...
            case 1:
                ...
                ps1eng = "I " + "haven " + vpeng[v] + nnobles[n];
    ...
    public void GenPresCont4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps3eng = "he is " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[r];
                ps3eng2 = "he is " + vnbc[v] + nnobles[n]  + prep.Oospecialeng[p][p2] + frequadv[r];

                ps3ella = "ella " + "está " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[r];
                ps3she = "she is " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[r];
                ps3she2 = "she is " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[r];

                ps3eso = "eso " + "está " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[r];
                ps3it = "it is " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[r];
                ps3iteng2 = "it is " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[r];

                ps4 = "ellos " + "están " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[r];
                ps4eng = "they are " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[r];
                ps4eng2 = "they are " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[r];

                ps5 = "nosotros " + "estamos " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[r];
                ps5eng = "we are " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[r];
                ps5eng2 = "we are " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[r];
            ...
            case 1:
                ...
                ps2eng2 = "you're not " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps4eng2 = "they're not " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps5eng2 = "we're not " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
    ...
    public void GenPastCont4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps4 = "ellos " + "estaban " + vnbc[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
            ...
            case 1:
                ...
                ps4 = "ellos no " + "estaban " + vnbc[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
    ...
    public void GenPastPerfCont4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps4 = "ellos " + "habían estado " + vnbc[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
            ...
            case 1:
                ...
                ps4 = "ellos no " + "habían estado " + vnbc[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
    ...
    public void GenFutPerfCont4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps4 = "ellos " + "habrán estado " + vnbc[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
            ...
            case 1:
                ...
                ps4 = "ellos no " + "habrán estado " + vnbc[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
    ...
    public void GenWouldPerfCont4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps4 = "ellos "  + "hubieran estado " + vnbc[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
            ...
            case 1:
                ...
                ps4 = "ellos no " + "hubieran estado " + vnbc[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
    ...
    public void GenShouldPerfCont4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps4 = "ellos "  + "debieron haber estado " + vnbc[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
            ...
            case 1:
                ...
                ps4 = "ellos no " + "debieron haber estado " + vnbc[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
    ...
    public void GenMustSimp4(){
        ...
        switch (negg) {
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "must not " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void GenMustCont4(){
        ...
        switch (negg) {
            ...
            case 1:
                ...
                ps3iteng2 = "it must not " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
