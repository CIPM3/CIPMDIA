    ...
    public void GenPresCont4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps3eng2 = "he is " + vnbc[v] + nnobles[n]  + prep.absspecialeng[p][p2] + frequadv[r];
                ...
                ps3she2 = "she is " + vnbc[v] + nnobles[n]+ prep.absspecialeng[p][p2] + frequadv[r];
                ...
                ps3iteng2 = "it is " + vnbc[v] + nnobles[n] + prep.absspecialeng[p][p2] + frequadv[r];
                ...
                ps4eng2 = "they are " + vnbc[v] + nnobles[n] + prep.absspecialeng[p][p2] + frequadv[r];
                ...
                ps5eng2 = "we are " + vnbc[v] + nnobles[n] + prep.absspecialeng[p][p2] + frequadv[r];
