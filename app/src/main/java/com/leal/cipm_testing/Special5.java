...
public class Special5 {
    ...
    public void randstarter(){
        ...
        //dif 4
        rd1 = (int) (Math.random() * happenspecial.length);
        rd1s = (int) (Math.random() * happenspecial[rd1].length);
        rd2 = (int) (Math.random() * bendspecial.length);
        rd2s = (int) (Math.random() * bendspecial[rd2].length);
    ...
    public void arraySpe(){
        ...
        switch (temp){
            case "happen ":
                arrayEsp = happenspecial[rd1][rd1s];
                arrayEng = sucederspecial[rd1][rd1s];
                break;

            case "bend ":
                arrayEsp = bendspecial[rd2][rd2s];
                arrayEng = doblarspecial[rd2][rd2s];
                break;
    ...
    public void forSubTo4() {
        ...
        switch (temp) {
            case "happen ":
                switch (neg) {
                    case 0:
                        sp1 = ftsjs[0] + v1s[rand] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        eng1 = ftsj[0] + verbs[rand] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp2 = ftsjs[1] + v2s[rand] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        eng2 = ftsj[1] + verbs[rand] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp3 = ftsjs[2] + v3s[rand] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        eng3 = ftsj[2] + verbs[rand] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp3ella = ftsjs[3] + v3s[rand] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        eng3she = ftsj[3] + verbs[rand] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp3eso = ftsjs[4] + v3s[rand] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        sp3it = ftsj[4] + verbs[rand] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp4 = ftsjs[5] + v4s[rand] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        eng4 = ftsj[5] + verbs[rand] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp5 = ftsjs[6] + v5s[rand] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        eng5 = ftsj[6] + verbs[rand] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        break;
                    case 1:
                        sp1 = ftsjsn[0] + v1s[rand] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        eng1 = ftsjn[0] + verbs[rand] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp2 = ftsjsn[1] + v2s[rand] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        eng2 = ftsjn[1] + verbs[rand] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp3 = ftsjsn[2] + v3s[rand] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        eng3 = ftsjn[2] + verbs[rand] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp3ella = ftsjsn[3] + v3s[rand] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        eng3she = ftsjn[3] + verbs[rand] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp3eso = ftsjsn[4] + v3s[rand] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        sp3it = ftsjn[4] + verbs[rand] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp4 = ftsjsn[5] + v4s[rand] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        eng4 = ftsjn[5] + verbs[rand] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp5 = ftsjsn[6] + v5s[rand] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        eng5 = ftsjn[6] + verbs[rand] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];
                        break;
                }
                break;
            ...
            case "bend ":
                switch (neg) {
                    case 0:
                        sp1 = ftsjs[0] + v1s[rand] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        eng1 = ftsj[0] + verbs[rand] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp2 = ftsjs[1] + v2s[rand] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        eng2 = ftsj[1] + verbs[rand] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp3 = ftsjs[2] + v3s[rand] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        eng3 = ftsj[2] + verbs[rand] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp3ella = ftsjs[3] + v3s[rand] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        eng3she = ftsj[3] + verbs[rand] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp3eso = ftsjs[4] + v3s[rand] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        sp3it = ftsj[4] + verbs[rand] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp4 = ftsjs[5] + v4s[rand] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        eng4 = ftsj[5] + verbs[rand] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp5 = ftsjs[6] + v5s[rand] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        eng5 = ftsj[6] + verbs[rand] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        break;
                    case 1:
                        sp1 = ftsjsn[0] + v1s[rand] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        eng1 = ftsjn[0] + verbs[rand] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp2 = ftsjsn[1] + v2s[rand] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        eng2 = ftsjn[1] + verbs[rand] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp3 = ftsjsn[2] + v3s[rand] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        eng3 = ftsjn[2] + verbs[rand] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp3ella = ftsjsn[3] + v3s[rand] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        eng3she = ftsjn[3] + verbs[rand] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp3eso = ftsjsn[4] + v3s[rand] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        sp3it = ftsjn[4] + verbs[rand] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp4 = ftsjsn[5] + v4s[rand] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        eng4 = ftsjn[5] + verbs[rand] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp5 = ftsjsn[6] + v5s[rand] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        eng5 = ftsjn[6] + verbs[rand] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];
                        break;
                }
                break;
    ...
    public void wantyouto4() {
        ...
        switch (temp) {
            case "happen ":
                switch (neg) {
                    case 0:
                        sp1 = wtsjs[0] + wtobj1s[rn1] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        eng1 = wtsj[0] + wtobj1[rn1] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp2 = wtsjs[1] + wtobj2s[rn1] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        eng2 = wtsj[1] + wtobj2[rn1] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp3 = wtsjs[2] + wtobj3s[rn1] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        eng3 = wtsj[2] +wtobj3[rn1] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp3ella = wtsjs[3] + wtobj4s[rn1] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        eng3she = wtsj[3] + wtobj4[rn1] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp3eso = wtsjs[4] + wtobj5s[rn1] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        sp3it = wtsj[4] + wtobj5[rn1] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp4 = wtsjs[5] + wtobj6s[rn2] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        sp3it = wtsj[4] + wtobj6[rn2] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp5 = wtsjs[6] + wtobj7s[rn1] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        eng5 = wtsj[6] + wtobj7[rn1] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        break;
                    case 1:
                        sp1 = wtsjsn[0] + wtobj1s[rn1] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        eng1 = wtsjn[0] + wtobj1[rn1] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp2 = wtsjsn[1] + wtobj2s[rn1] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        eng2 = wtsjn[1] + wtobj2[rn1] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp3 = wtsjsn[2] + wtobj3s[rn1] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        eng3 = wtsjn[2] + wtobj3[rn1] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp3ella = wtsjsn[3] + wtobj4s[rn1] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        eng3she = wtsjn[3] + wtobj4[rn1] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp3eso = wtsjsn[4] + wtobj5s[rn1] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        sp3it = wtsjn[4] + wtobj5[rn1] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp4 = wtsjsn[5] + wtobj6s[rn2] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        sp3it = wtsjn[4] + wtobj6[rn2] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];

                        sp5 = wtsjsn[6] + wtobj7s[rn1] + sorepe[rand1] + sucederspecial[rd1][rd1s] + advfrequ[radv];
                        eng5 = wtsjn[6] + wtobj7[rn1] + sorep[rand1] + happenspecial[rd1][rd1s] + frequadv[radv];
                        break;
                }
                break;
            ...
            case "bend ":
                switch (neg) {
                    case 0:
                        sp1 = wtsjs[0] + wtobj1s[rn1] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        eng1 = wtsj[0] + wtobj1[rn1] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp2 = wtsjs[1] + wtobj2s[rn1] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        eng2 = wtsj[1] + wtobj2[rn1] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp3 = wtsjs[2] + wtobj3s[rn1] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        eng3 = wtsj[2] +wtobj3[rn1] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp3ella = wtsjs[3] + wtobj4s[rn1] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        eng3she = wtsj[3] + wtobj4[rn1] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp3eso = wtsjs[4] + wtobj5s[rn1] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        sp3it = wtsj[4] + wtobj5[rn1] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp4 = wtsjs[5] + wtobj6s[rn2] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        sp3it = wtsj[4] + wtobj6[rn2] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp5 = wtsjs[6] + wtobj7s[rn1] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        eng5 = wtsj[6] + wtobj7[rn1] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        break;
                    case 1:
                        sp1 = wtsjsn[0] + wtobj1s[rn1] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        eng1 = wtsjn[0] + wtobj1[rn1] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp2 = wtsjsn[1] + wtobj2s[rn1] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        eng2 = wtsjn[1] + wtobj2[rn1] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp3 = wtsjsn[2] + wtobj3s[rn1] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        eng3 = wtsjn[2] + wtobj3[rn1] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp3ella = wtsjsn[3] + wtobj4s[rn1] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        eng3she = wtsjn[3] + wtobj4[rn1] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp3eso = wtsjsn[4] + wtobj5s[rn1] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        sp3it = wtsjn[4] + wtobj5[rn1] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp4 = wtsjsn[5] + wtobj6s[rn2] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        sp3it = wtsjn[4] + wtobj6[rn2] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];

                        sp5 = wtsjsn[6] + wtobj7s[rn1] + sosoltar[rand2] + doblarspecial[rd2][rd2s] + advfrequ[radv];
                        eng5 = wtsjn[6] + wtobj7[rn1] + sorelease[rand2] + bendspecial[rd2][rd2s] + frequadv[radv];
                        break;
                }
                break;
        }
