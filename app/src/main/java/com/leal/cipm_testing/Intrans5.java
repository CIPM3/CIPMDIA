...
public class Intrans5 {

    Generator5 gen = new Generator5();
    ...
    String vib[] = {
            "reir ", "vivir ", "inclinarse ", "saltar "
    };

    String vibesp[] = {
            "reír ", "vivir ", "inclinarse ", "saltar "
    };

    // Pasado
    String vibpast[] = {
            "rió ", "vivió ", "se inclinó ", "saltó "
    };

    // Verbos base en pasado
    String vibp1[] = {
            "reía ", "vivía ", "se inclinaba ", "saltaba "
    };
    ...
    String vibp2[] = {
            "reías ", "vivías ", "te inclinabas ", "saltabas "
    };

    String vibp2pr[] = {
            "reíste ", "viviste ", "te inclinaste ", "saltaste "
    };
    ...
    String vibp4[] = {
            "reían ", "vivían ", "se inclinaban ", "saltaban "
    };

    String vibp4pr[] = {
            "rieron ", "vivieron ", "se inclinaron ", "saltaron "
    };

    String vibp5[] = {
            "reíamos ", "vivíamos ", "nos inclinábamos ", "saltábamos "
    };

    String vibp5pr[] = {
            "reímos ", "vivimos ", "nos inclinamos ", "saltamos "
    };

    String vib3[] = {
            "laughs ", "lives ", "leans ", "leaps "
    };

    String vib3esp[] = {
            "ríe ", "vive ", "se inclina ", "salta "
    };

    String vib3cont[] = {
            "laughing ", "living ", "leaning ", "leaping "
    };

    String vib3contesp[] = {
            "riendo ", "viviendo ", "inclinándose ", "saltando "
    };

    String viparticiple[] = {
            "laughed ", "lived ", "leaned ", "leaped "
    };

    String vibparticipiosp[] = {
            "reído ", "vivido ", "inclinado ", "saltado "
    };

    String vib1[] = {
            "me río ", "vivo ", "me inclino ", "salto "
    };

    String vib2[] = {
            "te ríes ", "vives ", "te inclinas ", "saltas "
    };

    String vib3p[] = {
            "se ríe ", "vive ", "se inclina ", "salta "
    };

    String vib4[] = {
            "se ríen ", "viven ", "se inclinan ", "saltan "
    };

    String vibnos[] = {
            "nos reímos ", "vivimos ", "nos inclinamos ", "saltamos "
    };

    String vib1f[] = {
            "me reiré ", "viviré ", "me inclinaré ", "saltaré "
    };

    String vib2f[] = {
            "te reirás ", "vivirás ", "te inclinarás ", "saltarás "
    };

    String vib3f[] = {
            "se reirá ", "vivirá ", "se inclinará ", "saltará "
    };

    String vib4f[] = {
            "se reirán ", "vivirán ", "se inclinarán ", "saltarán "
    };

    String vibfnos[] = {
            "nos reiremos ", "viviremos ", "nos inclinaremos ", "saltaremos "
    };

    String vib1s[] = {
            "me ría ", "viva ", "me incline ", "salte "
    };

    String vib2s[] = {
            "te rías ", "vivas ", "te inclines ", "saltes "
    };

    String vib3s[] = {
            "se ría ", "viva ", "se incline ", "salte "
    };

    String vib4s[] = {
            "se rían ", "vivan ", "se inclinen ", "salten "
    };

    String vib5s[] = {
            "nos riamos ", "vivamos ", "nos inclinemos ", "saltemos "
    };

    String vib1w[] = {
            "me reiría ", "viviría ", "me inclinaría ", "saltaría "
    };

    String vib2w[] = {
            "te reirías ", "vivirías ", "te inclinarías ", "saltarías "
    };

    String vib3w[] = {
            "se reiría ", "viviría ", "se inclinaría ", "saltaría "
    };

    String vib4w[] = {
            "se reirían ", "vivirían ", "se inclinarían ", "saltarían "
    };

    String vib5w[] = {
            "nos reiríamos ", "viviríamos ", "nos inclinaríamos ", "saltaríamos "
    };
    ...
    public void randstarter() {
        ...
        rand3 = (int) (Math.random() * laughSpecial.length);
        rand4 = (int) (Math.random() * laughSpecial[rand3].length);
        r5 = (int) (Math.random() * liveSpecial.length);
        r6 = (int) (Math.random() * liveSpecial[r5].length);
        r7 = (int) (Math.random() * leanSpecial.length);
        r8 = (int) (Math.random() * leanSpecial[r7].length);
        r9 = (int) (Math.random() * leapSpecial.length);
        r10 = (int) (Math.random() * leapSpecial[r9].length);
    }
    ...
    public void arraySpe(){
        ...
        switch (temp){
            case "sing ":
                arrayEsp = laughSpecial[rand3][rand4];
                arrayEng = reirSpecial[rand3][rand4];

                break;
            case "slide ":
                arrayEsp = liveSpecial[r5][r6];
                arrayEng = vivirSpecial[r5][r6];

                break;
            case "cry ":
                arrayEsp = leanSpecial[r7][r8];
                arrayEng = inclinarseSpecial[r7][r8];

                break;
            case "concentrate ":
                arrayEsp = leapSpecial[r9][r10];
                arrayEng = saltarSpecial[r9][r10];
