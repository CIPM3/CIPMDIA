...
public class Nobles4 {


    //vnb verbos nobles top 100
    String vnb[] = {
            "touch ", "push ", "burn ", "draw ", "drag ", "seek "
    };


    // verbos nobles base spanish
    String vnbs[] = {
            "tocar ", "empujar ", "quemar ", "dibujar ", "arrastrar ", "buscar "
    };
    //vnb verbos nobles top 100  tercera persona inglés
    String vnb3[] = {
            "touches ", "pushes ", "burns ", "draws ", "drags ", "seeks "
    };

    //vnb verbos nobles top 100  primera persona esp
    String vn1[] = {
            "toco ", "empujo ", "quemo ", "dibujo ", "arrastro ", "busco "
    };
    //vnb verbos nobles top 100  segunda persona esp
    String vn2[] = {
            "tocas ", "empujas ", "quemas ", "dibujas ", "arrastras ", "buscas "
    };
    //vnb verbos nobles top 100  tercera persona esp
    String vn3[] = {
            "toca ", "empuja ", "quema ", "dibuja ", "arrastra ", "busca "
    };
    //vnb verbos nobles top 100  cuarta persona esp ellos
    String vn4[] = {
            "tocan ", "empujan ", "queman ", "dibujan ", "arrastran ", "buscan "
    };
    //vnb verbos nobles top 100  quinta persona esp nosotros
    String vn5[] = {
            "tocamos ", "empujamos ", "quemamos ", "dibujamos ", "arrastramos ",
            "buscamos "
    };

    //pasados (agregado wish SV 060422)
    String ps1wish[] = {
            "tocara ", "empujara ", "quemara ", "dibujara ", "arrastrara ", "buscara "
    };
    String ps2wish[] = {
            "tocaras ", "empujaras ", "quemaras ", "dibujaras ", "arrastraras ", "buscaras "
    };
    String ps3wish[] = {
            "tocara ", "empujara ", "quemara ", "dibujara ", "arrastrara ", "buscara "
    };
    String ps4wish[] = {
            "tocaran ", "empujaran ", "quemaran ", "dibujaran ", "arrastraran ", "buscaran "
    };
    String ps5wish[] = {
            "tocáramos ", "empujáramos ", "quemáramos ", "dibujáramos ", "arrastráramos ",
            "buscáramos "
    };

    // nouns nobles top 100
    String nnobles[] = {
            "the disaster  ", "the efficiency  ", "the excitement ", "the extent ",
            "the feedback ", "the guitar ", "the outcome ",
            "the presentation ", "the promotion ", "the reflection ",
            "the refrigerator ", "the resolution ", "the revenue ", "the session ",
            "the tennis ", "the basket ", "the bonus ", "the cabinet ", "the childhood ",
            "the church ", "the clothes ", "the coffee ", "the dinner ", "the drawing ",
            "the hair ", "the hearing ", "the initiative ", "the judgment ", "the lab ",
            "the measurement ", "the mud ", "the orange ", "the poetry ", "the possibility ",
            "the procedure ", "the ratio ", "the relation ", "the restaurant ",
            "the satisfaction ", "the sector ", "the signature ", "the significance ",
            "the song ", "the town ", "the vehicle ", "the volume ",
            "the accident ", "the airport ", "the appointment ", "the arrival ",
            "the assumption ", "the baseball ", "the chapter ", "the committee ",
    ...
    String nnoblesesp[] = {
            ...
            "la retroalimentación ", "la guitarra ", "el resultado ",
            "la presentación ", "la promoción ", "el reflejo ",
            ...
            "el pelo ", "el oído ", "la iniciativa ", "el juicio ", "el laboratorio ",
            ...
            "la canción ", "a el pueblo ", "el vehículo ", "el volumen ",
    ...
    String vnbp[] = {
            "touched ", "pushed ", "burned ", "draw ", "dragged ", "sougth "
    };

    //pasado simple primera persona uno (preterito)
    String ps1pre[] = {
            "toqué ", "empujé ", "quemé ", "dibujé ", "arrastré ", "buscé "
    };
    //pasado simple primera persona 2 (imperfecto)
    String ps1imp[] = {
            "tocaba ", "empujaba ", "quemaba ", "dibujaba ", "arrastraba ", "buscaba "
    };
    //pasado simple segunda persona preterito
    String ps2pre[] = {
            "tocaste ", "empujaste ", "quemaste ", "dibujaste ", "arrastraste ", "buscaste "
    };
    //pasado simple segunda persona imperfecto
    String ps2imp[] = {
            "tocabas ", "empujabas ", "quemabas ", "dibujabas ", "arrastrabas ", "buscabas "
    };
    //pasado simple tercera persona preterito
    String ps3p[] = {
            "tocó ", "empujó ", "quemó ", "dibujó ", "arrastró ", "buscó "
    };
    //pasado simple tercera persona imperfecto
    String ps3imp[] = {
            "tocaba ", "empujba ", "quemaba ", "dibujaba ", "arrastraba ", "buscaba "
    };
    //verbos nobles cuarta persona (ellos) pasado preterito
    String vn4p[] = {
            "tocaron ", "empujaron ", "quemaron ", "dibujaron ", "arrastraron ", "buscaron "
    };
    //verbos nobles cuarta persona (ellos) pasado imperfecto
    String vn4imp[] = {
            "tocaban ", "empujaban ", "quemaban ", "dibujaban ", "arrastraban ", "buscaban "
    };
    ...
    String vn5imp[] = {
            "tocábamos ", "empujábamos ", "quemábamos ", "dibujábamos ", "arrastrábamos ",
            "buscábamos "
    };
    ...
    String vnbc[] = {
            "touching ", "pushing ", "burning ", "draw ", "dragding ", "seeking "
    };
    //vnb verbos nobles top 100 continuo spanish
    String vnbcs[] = {
            "tocando ", "empujando ", "quemando ", "dibujando ", "arrastrando ",
            "buscando "
    };
    ...
    String vpsp[] = {
            "tocado ", "empujado ", "quemado ", "dibujado ", "arrastrado ", "buscado "
    };

    // verbos nobles primera persona futuro
    String vn1f[] = {
            "tocaré ", "empujaré ", "quemaré ", "dibujaré ", "arrastraré ", "buscaré "
    };
    // verbos nobles segunda persona futuro
    String vn2f[] = {
            "tocarás ", "empujarás ", "quemarás ", "dibujarás ", "arrastrarás ",
            "buscarás "
    };
    // verbos nobles tercera persona futuro
    String vn3f[] = {
            "tocará ", "empujará ", "quemará ", "dibujará ", "arrastrará ", "buscará "
    };
    // verbos nobles cuarta persona futuro
    String vn4f[] = {
            "tocarán ", "empujarán ", "quemarán ", "dibujarán ", "arrastrarán ",
            "buscarán "
    };
    // verbos nobles quinta persona futuro
    String vn5f[] = {
            "tocaremos ", "empujaremos ", "quemaremos ", "dibujaremos ", "arrastraremos ",
            "buscaremos "
    };
    ...
    String vn1w[] = {
            "tocaría ", "empujaría ", "quemaría ", "dibujaría ", "arrastraría ",
            "buscaría "
    };
    // verbos nobles segunda persona would
    String vn2w[] = {
            "tocarías ", "empujarías ", "quemarías ", "dibujarías ", "arrastrarías ",
            "buscarías "
    };
    ...
    String vn4w[] = {
            "tocarían ", "empujarían ", "quemarían ", "dibujarían ", "arrastrarían ",
            "buscarían "
    };
    // verbos nobles quinta persona would
    String vn5w[] = {
            "tocaríamos ", "empujaríamos ", "quemaríamos ", "dibujaríamos ",
            "arrastraríamos ", "buscaríamos "
    };
...
// aqui van los del might
    ...
    String vn1y3subj[] = {
            "toque ", "empuje ", "queme ", "dibuje ", "arrastre ", "busque "
    };
    // verbos nobles segunda persona subjuntivo
    String vn2subj[] = {
            "toques ", "empujes ", "quemes ", "dibujes ", "arrastres ", "busques "
    };
    //vnb verbos nobles top 100  cuarta persona esp subjuntivos
    String vn4subj[] = {
            "toquen ", "empujen ", "quemen ", "dibujen ", "arrastren ", "busquen "
    };
    //vnb verbos nobles nosotros subjuntivo
    String vn5subj[] = {
            "toquemos ", "empujemos ", "quememos ", "dibujemos ", "arrastremos ",
            "busquemos "
    };

    String advfrequ[] = {
            "siempre ", "constantemente ", "frecuentemente ",
            "generalmente ", "normalmente ", "ocacionalmente ", "seguido ",
            "raramente ", "regularmente ", "regularmente ", "usualmente ",
            "felizmente ", "temprano ", "tarde ", "diariamente ", "perfectamente ",
            "facilmente ", "cuidadosamente ", "abiertamente ", "finalmente ",
            "peligrosamente ", "desesperadamente ", "ocasionalmente ",
            "seguido ", "calmadamente "
    };
    String frequadv[] = {
            "always ", "constantly ", "frequently ", "generally ",
            "normally ", "occasionally ", "often ", "rarely ", "regularly ",
            "regularly ", "usually ", "happily ", "early ", "late ", "daily ",
            "perfectly ", "easily ", "carefully ", "openly ", "finally ",
            "dangerouslly ", "desperately ", "occasionally ", "often ",
            "calmly "
    };
    ...
    public void GenPastPerf2() {
        switch (neg) {
            case 0:
                ...
                ps3iteng2 = "it'd " + vpeng[v] + nnobles[n];
    ...
    public void GenMightPerf2() {
        ...
        switch (neg) {
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "might not have " + vpeng[v] + nnobles[n];
    ...
    public void GenPresCont4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps3iteng2 = "it's " + vnbc[v] + nnobles[n] + prep.noblesspecialeng[p][p2] + advfrequ[r];
    ...
    public void GenPresPerf4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps3iteng2 = "it's " + vpeng[v] + nnobles[n] + prep.noblesspecialeng[p][p2] + frequadv[r];
    ...
    public void GenPastPerf4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps3iteng2 = "it'd " + vpeng[v] + nnobles[n] + prep.noblesspecialeng[p][p2] + frequadv[r];
    ...
    public void GenFutCont4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps3iteng2 = "it'll " + "be " + vnbc[v] + nnobles[n] + prep.noblesspecialeng[p][p2] + frequadv[r];
    ...
    public void GenFutPerf4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps3iteng2 = "it'll " + "have " + vpeng[v] + nnobles[n] + prep.noblesspecialeng[p][p2] + frequadv[r];
    ...
    public void GenWouldPerf4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps3iteng2 = "it'd " + "have " + vpeng[v] + nnobles[n] + prep.noblesspecialeng[p][p2] + frequadv[radv];
    ...
    public void GenShouldCont4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps3iteng2 = "it'd " + "be " + vnbc[v] + nnobles[n] + prep.noblesspecialeng[p][p2] + frequadv[radv];
    ...
    public void GenMightCont4() {
        ...
        switch (negg) {
            ...
            case 1:
                ...
                ps3iteng2 = "it mightn't " + "be " + vnbc[v] + nnobles[n] + prep.noblesspecialeng[p][p2] + frequadv[radv];
    ...
    public void GenMightPerf4() {
        ...
        switch (negg) {
            ...
            case 1:
                ...
                ps3iteng2 = "it mightn't " + "have " + vpeng[v] + nnobles[n] + prep.noblesspecialeng[p][p2] + frequadv[radv];
    ...
    public void GenFutPerf1() {
        switch (neg) {
            case 0:
                ...
                ps3iteng2 = "it " + "will have " + vpeng[v];
