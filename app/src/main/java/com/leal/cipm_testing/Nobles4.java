...
public class Nobles4 {
    ...
    String nnobles[] = {
            ...
            "the feedback ", "the guitar ", "the homework ", "the outcome ",
            "the permission ", "the presentation ", "the promotion ", "the reflection ",
