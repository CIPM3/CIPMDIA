    ...
    public void GenWouldPerfCont4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps4 = "ellos "  + "hubieran estado " + vnbc[v] + nnoblesesp[n] + prep.noblesspecial[p][p2] + advfrequ[radv];
            ...
            case 1:
                ...
                ps4 = "ellos no " + "hubieran estado " + vnbc[v] + nnoblesesp[n] + prep.noblesspecial[p][p2] + advfrequ[radv];
