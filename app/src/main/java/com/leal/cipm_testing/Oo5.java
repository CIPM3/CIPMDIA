...
public class Oo5 {
    ...
    //OBJETOS
    String nnobles[] = {
            "the refrigerator ", "the basket ", "the cabinet ", "the lab ",
            "the restaurant ", "the vehicle ", "the airport ", "the gate ",
            "the hospital ", "the art ", "the money ", "the information ",
            "the map ", "the system ", "the computer ", "the television ",
            "the industry ", "the department "
    };
    String nnoblesesp[] = {
            "el refrigerador ", "la canasta ", "el gabinete ", "el laboratorio ",
            "el restaurante ", "el vehículo ", "el aeropuerto ", "la puerta ",
            "el hospital ", "el arte ", "el dinero ", "la información ",
            "el mapa ", "el sistema ", "la computadora ", "la televisión ",
            "la industria ", "el departamento "
    };

    //FRACES PREPOSICIONALES
    String advfrequ[] = {
            "siempre ", "constantemente ", "frecuentemente ", "generalmente ",
    ...
    public void GenFutPerf1() {
        switch (neg) {
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "won't have " + vpeng[v];
    ...
    public void GenWouldCont1() {
        switch (neg) {
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "wouldn't be " + vnbc[v];
    ...
    public void GenWouldPerf1() {
        switch (neg) {
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "wouldn't have " + vpeng[v];
    ...
    public void GenCouldCont1() {
        switch (neg) {
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "couldn't be " + vnbc[v];
    ...
    public void GenCouldPerf1() {
        switch (neg) {
            ...
            case 0:
                ...
                ps3iteng2 = "it " + "could have " + vpeng[v];
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "couldn't have " + vpeng[v];
    ...
    public void GenShouldCont1() {
        switch (neg) {
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "shouldn't be " + vnbc[v];
    ...
    public void GenShouldPerf1() {
        switch (neg) {
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "shouldn't have " + vpeng[v];
    ...
    public void GenMightCont1() {
        switch (neg) {
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "mightn't be " + vnbc[v];
    ...
    public void GenMightPerf1() {
        switch (neg) {
            case 0:
                ...
                ps3iteng2 = "it " + "might have " + vpeng[v];
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "mightn't have " + vpeng[v];
    ...
    public void GenMustCont1() {
        switch (neg) {
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "mustn't be " + vnbc[v];
    ...
    public void GenPresCont2() {
        switch (neg) {
            case 0:
                ...
                ps3iteng2 = "it's " + vnbc[v] + nnobles[n];
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "isn't " + vnbc[v] + nnobles[n];
    ...
    public void GenPresPerf2() {
        switch (neg) {
            case 0:
                ...
                ps3iteng2 = "it's " + vpeng[v] + nnobles[n];
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "hasn't " + vpeng[v] + nnobles[n];
    ...
    public void GenPastCont2() {
        switch (neg) {
            case 0:
                ...
                ps3iteng2 = "it " + "was " + vnbc[v] + nnobles[n];
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "wasn't " + vnbc[v] + nnobles[n];
    ...
    public void GenPastPerf2() {
        switch (neg) {
            case 0:
                ...
                ps3iteng2 = "it " + "had " + vpeng[v] + nnobles[n];
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "hadn't " + vpeng[v] + nnobles[n];
    ...
    public void GenFutCont2() {
        switch (neg) {
            case 0:
                ...
                ps3iteng2 = "it'll be " + vnbc[v] + nnobles[n];
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "won't be " + vnbc[v] + nnobles[n];
    ...
    public void GenFutPerf2() {
        switch (neg) {
            case 0:
                ...
                ps3iteng2 = "it'll have " + vpeng[v] + nnobles[n];
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "won't have " + vpeng[v] + nnobles[n];
    ...
    public void GenWouldCont2() {
        switch (neg) {
            case 0:
                ...
                ps3iteng2 = "it'd be " + vnbc[v] + nnobles[n];
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "wouldn't be " + vnbc[v] + nnobles[n];
    ...
    public void GenWouldPerf2() {
        switch (neg) {
            case 0:
                ...
                ps3iteng2 = "it'd have " + vpeng[v] + nnobles[n];
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "wouldn't have " + vpeng[v] + nnobles[n];
    ...
    public void GenCouldCont2() {
        switch (neg) {
            case 0:
                ...
                ps3iteng2 = "it " + "could be " + vnbc[v] + nnobles[n];
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "couldn't be " + vnbc[v] + nnobles[n];
    ...
    public void GenCouldPerf2() {
        switch (neg) {
            ...
            case 0:
                ...
                ps3iteng2 = "it " + "could have " + vpeng[v] + nnobles[n];
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "couldn't have " + vpeng[v] + nnobles[n];
    ...
    public void GenShouldCont2() {
        switch (neg) {
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "shouldn't be " + vnbc[v] + nnobles[n];
    ...
    public void GenShouldPerf2() {
        switch (neg) {
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "shouldn't have " + vpeng[v] + nnobles[n];
    ...
    public void GenMightCont2() {
        ...
        switch (neg) {
            case 0:
                ...
                ps3iteng2 = "it " + "might be " + vnbc[v] + nnobles[n];
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "mightn't be " + vnbc[v] + nnobles[n];
    ...
    public void GenMightPerf2() {
        switch (neg) {
            case 0:
                ...
                ps3iteng2 = "it " + "might have " + vpeng[v] + nnobles[n];
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "mightn't have " + vpeng[v] + nnobles[n];
    ...
    public void GenCanCont2() {
        switch (neg) {
            case 0:
                ...
                ps3iteng2 = "it " + "can be " + vnbc[v] + nnobles[n];
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "can't be " + vnbc[v] + nnobles[n];
    ...
    public void GenMustCont2() {
        ...
        switch (neg) {
            case 0:
                ...
                ps3iteng2 = "it " + "must be " + vnbc[v] + nnobles[n];
            ...
            case 1:
                ...
                ps3iteng2 = "it " + "mustn't be " + vnbc[v] + nnobles[n];
    ...
    public void GenPresCont3() {
        switch (negg) {
            case 0:
                ...
                ps3iteng2 = "it's " + vnbc[v] + nnobles[n] + frequadv[r];
    ...
    public void GenPresPerf3() {
        switch (negg) {
            case 0:
                ...
                ps3iteng2 = "it's " + vpeng[v] + nnobles[n] + frequadv[r];
    ...
    public void GenPastPerf3() {
        switch (negg) {
            case 0:
                ...
                ps3iteng2 = "it'd " + vpeng[v] + nnobles[n] + frequadv[r];
    ...
    public void GenFutCont3() {
        switch (negg) {
            case 0:
                ...
                ps3iteng2 = "it'll " + "be " + vnbc[v] + nnobles[n] + frequadv[r];
    ...
    public void GenFutPerf3() {
        switch (negg) {
            case 0:
                ...
                ps3iteng2 = "it'll " + "have " + vpeng[v] + nnobles[n] + frequadv[r];
    ...
    public void GenWouldCont3() {
        switch (negg) {
            case 0:
                ...
                ps3iteng2 = "it'd " + "be " + vnbc[v] + nnobles[n] + frequadv[r];
    ...
    public void GenWouldPerf3() {
        switch (negg) {
            case 0:
                ...
                ps3iteng2 = "it'd " + "have " + vpeng[v] + nnobles[n] + frequadv[r];
    ...
    public void GenMightCont3() {
        switch (negg) {
            ...
            case 1:
                ...
                ps3iteng2 = "it mightn't " + "be " + vnbc[v] + nnobles[n] + frequadv[r];
    ...
    public void GenMightPerf3() {
        switch (negg) {
            ...
            case 1:
                ...
                ps3iteng2 = "it mightn't " + "have " + vpeng[v] + nnobles[n] + frequadv[r];
    ...
    public void GenPresCont4() {
        ...
        int p2=(int)(Math.random()*prep.Oospecialeng[p].length);
        switch (negg) {
            case 0:
                ...
                ps3iteng2 = "it's " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + advfrequ[r];
    ...
    public void GenPresPerf4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps3iteng2 = "it's " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
    ...
    public void GenPresPerfCont4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps3 = "él " + "ha estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
    ...
    public void GenPastPerf4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps3iteng2 = "it'd " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
    ...
    public void GenPastPerfCont4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps3 = "él " + "había estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
            ...
            case 1:
                ...
                ps3 = "él no " + "había estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
    ...
    public void GenFutCont4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps3iteng2 = "it'll " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
    ...
    public void GenFutPerf4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps3iteng2 = "it'll " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
    ...
    public void GenFutPerfCont4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps3 = "él " + "habrá estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
            ...
            case 1:
                ...
                ps3 = "él no " + "habrá estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
    ...
    public void GenWouldCont4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps3iteng2 = "it'd " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void GenWouldPerf4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps3iteng2 = "it'd " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void GenWouldPerfCont4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps3 = "él "  + "hubiera estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
            ...
            case 1:
                ...
                ps3 = "él no " + "hubiera estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv]; ;
    ...
    public void GenMightCont4() {
        ...
        switch (negg) {
            ...
            case 1:
                ...
                ps3iteng2 = "it mightn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void GenMightPerf4() {
        ...
        switch (negg) {
            ...
            case 1:
                ...
                ps3iteng2 = "it mightn't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void GenMightPerfCont4() {
        ...
        switch (negg) {
            ...
            case 1:
                ...
                ps1eng2 = "I might not " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps2eng2 = "you might not " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps3eng2 = "he might not " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps3she2 = "she might not " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng2 = "they might not " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps5eng2 = "we might not " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    String vg5[]={
            "enojamos ", "aburrimos ", "confundimos ", "cansamos ", "alegramos ",
