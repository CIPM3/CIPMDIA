...
public class Oo4 {
    ...
    String nnobles[] = {
            "the presentation ", "the promotion ", "the refrigerator ", "the session ", "the basket ",
            "the cabinet ", "the church ", "the initiative ", "the lab ", "the possibility ", "the restaurant ",
            "the sector ", "the song ", "the vehicle ", "the airport ", "the database ", "the gate ", "the hospital ",
            "the speech ", "the village ",
    };

    String nnoblesesp[] = {
            "la presentación ", "la promoción ", "el refrigerador ", "la sesión ",
