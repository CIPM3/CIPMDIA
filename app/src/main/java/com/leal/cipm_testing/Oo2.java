    ...
    public void GenPresSimp4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps5eng2 = "we " + vnb[v] + nnobles[n] +prep.Oospecialeng[p][p2] + frequadv[r]+ frequadv[r] ;

                break;
            case 1:
                ps1 = "yo " + "no " + vn1[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps1eng = "I " + "don't " + vnb[v] + nnobles[n]+prep.Oospecial[p][p2] + frequadv[r] ;
                ps1eng2 = "I " + "don't " + vnb[v] + nnobles[n] +prep.Oospecial[p][p2] + frequadv[r]+ frequadv[r] ;
                ...
                ps2eng2 = "you " + "don't " + vnb[v] + nnobles[n] +prep.Oospecialeng[p][p2] + frequadv[r]+ frequadv[r] ;
                ...
                ps3eng2 = "he " + "doesn't " + vnb[v] + nnobles[n] +prep.Oospecialeng[p][p2] + frequadv[r]+ frequadv[r] ;
                ...
                ps3she2 = "she " + "doesn't " + vnb[v] + nnobles[n] +prep.Oospecialeng[p][p2] + frequadv[r]+ frequadv[r] ;
                ...
                ps3iteng2 = "it " + "doesn't " + vnb[v] + nnobles[n] +prep.Oospecialeng[p][p2] + frequadv[r]+ frequadv[r] ;
                ...
                ps4eng2 = "they " + "don't " + vnb[v] + nnobles[n] +prep.Oospecialeng[p][p2] + frequadv[r]+ frequadv[r] ;
                ...
                ps5eng2 = "we " + "don't " + vnb[v] + nnobles[n] +prep.Oospecialeng[p][p2] + frequadv[r]+ frequadv[r] ;
    ...
    public void GenPresCont4() {
        ...
        switch (negg) {
            ...
            case 1:
                ...
                ps3eng2 = "he's not " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps3she2 = "she's not " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps3iteng2 = "it's not " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
        ...
        switch (neg) {
            ...
            case 0:
                if (sr == 0) {
                    ...
                    ps5eng = "we " + "didn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                    ps5eng2 = "we " + "didn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r]+ frequadv[r];
    ...
    public void GenFutCont4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps4 = "ellos " + "estarán " + vnbc[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
    ...
    public void GenFutPerf4() {
        ...
        switch (negg) {
            ...
            case 1:
                ...
                ps3she2 = "she won't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r]+ frequadv[r];
                ...
                ps5eng2 = "we won't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r]+ frequadv[r];
    ...
    public void GenFutPerfCont4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps2eng2 = "you will have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r]+ frequadv[r];
                ...
                ps3eng2 = "he will have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r]+ frequadv[r];
                ...
                ps3she2 = "she will have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r]+ frequadv[r];
                ...
                ps3iteng2 = "it will have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r]+ frequadv[r];
                ...
                ps4eng2 = "they will have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r]+ frequadv[r];
                ...
                ps5eng2 = "we will have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r]+ frequadv[r];
            ...
            case 1:
                ...
                ps2eng2 = "you won't have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r]+ frequadv[r];
