...
public class Oo2 {
    ...
    String nnobles[] = {
            ...
            "the newspaper ", "the cell ", "the lake ", "the message ", "the phone ", "the photo ",
            "the recipe ", "the studio "
    };
    ...
    String nnoblesesp[] = {
            ...
            "la celda ", "el lago ", "el mensaje ", "el teléfono ", "la foto ", "la receta ",
            "el estudio "
    };
