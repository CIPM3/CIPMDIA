...
public class Intrans4 {
    ...
    String vib[] = {
            "sing ", "slide ", "cry ", "concentrate ", "doubt ",
            "march ", "die ", "jump ", "dig ", "escape ",
            "sleep ", "advance ", "wonder ", "hang ", "count ",
            "laugh ", "struggle ", "swim ", "hide ", "train "
    };

    String vibesp[] = {
            "cantar ", "deslizarse ", "llorar ", "concentrarse ", "dudar ",
            "marchar ", "morir ", "saltar ", "excavar ", "escaparse ",
            "dormir ", "avanzar ", "preguntarse ", "colgar ", "contar ",
            "reírse ", "batallar ", "nadar ", "esconder ", "entrenar "
    };

    //pasado
    String vibpast[]={
            "singed ","slided ","cryed ","concentrated ","doubted ",
            "marched ","died ","jumped ","diged ","escaped ",
            "sleeped ","advanced ","wondered ","hanged ","counted ",
            "laughed ","struggled ","swimed ","hided ","trained "
    };

    //verbos base en pasado
    String vibp1[]={
            "cantaba ","deslizaba ","lloraba ","me concentraba ","dudaba ",
            "marchaba ","moria ","saltaba ","excavaba ","me escapaba ",
            "dormia ","avanzaba ","preguntaba ","colgaba ","contaba ",
            "reia ","batallaba ","nadaba ","me escondia ","entrenaba "
    };

    String vibp1pr[]={
            "cante ","deslize ","llore ","me concentre ","dude ",
            "marche ","mori ","salte ","excave ","me escape ",
            "dormi ","avazce ","pregunte ","colge ","conte ",
            "rei ","batalle ","nade ","me escondi ","entrene "
    };

    String vibp2[]={
            "cantabas ","deslizabas ","llorabas ","te concentrabas ","dudabas ",
            "marchabas ","morias ","saltabas ","excavabas ","te escapabas ",
            "dormias ","avanzabas ","preguntabas ","colgabas ","contabas ",
            "reias ","batallabas ","nadabas ","te escondias ","entrenabas "
    };

    String vibp2pr[]={
            "cantaste ","deslizaste ","lloraste ","te concentraste ","dudaste ",
            "marchaste ","moriste ","saltaste ","excavaste ","te escapaste ",
            "dormiste ","avanzaste ","preguntaste ","colgaste ","contaste ",
            "reiste ","batallaste ","nadaste ","te escondiste ","entrenaste "
    };

    String vibp3[]={
            "cantaba ","deslizaba ","lloraba ","se concentraba ","dudaba ",
            "marchaba ","moria ","saltaba ","excavaba ","se escapaba ",
            "dormia ","avanzaba ","preguntaba ","colgaba ","contaba ",
            "reia ","batallaba ","nadaba ","se escondia ","entrenaba "
    };

    String vibp3pr[]={
            "canto ","deslizo ","lloro ","se concentro ","dudo ",
            "marcho ","murio ","salto ","excavo ","se escapo ",
            "durmio ","avanzo ","pregunto ","colgo ","conto ",
            "río ","batallo ","nado ","se escondio ","entreno "
    };

    String vibp4[]={
            "cantaban ","deslizaban ","lloraban ","se concentraban ","dudaban ",
            "marchaban ","morian ","saltaban ","excavaban ","se escapaban ",
            "dormian ","avanzaban ","preguntaban ","colgaban ","contaban ",
            "reian ","batallaban ","nadaban ","se escondian ","entrenaban "
    };

    String vibp4pr[]={
            "cantaron ","deslizaron ","lloraron ","se concentraron ","dudaron ",
            "marcharon ","murieron ","saltaron ","excavaron ","se escaparon ",
            "durmieron ","avanzaron ","preguntaron ","colgaron ","contaron ",
            "rieron ","batallaron ","nadaron ","se escondieron ","entrenaron "
    };

    String vibp5[]={
            "cantabamos ","deslizabamos ","llorabamos ","nos concentrabamos ","dudabamos ",
            "marchabamos ","moriamos ","saltabamos ","excavabamos ","nos escapabamos ",
            "dormiamos ","avanzabamos ","preguntabamos ","colgabamos ","contabamos ",
            "reiamos ","batallabamos ","nadabamos ","nos escondiamos ","entrenabamos "
    };

    String vibp5pr[]={
            "cantamos ","deslizamos ","lloramos ","nos concentramos ","dudamos ",
            "marchamos ","morimos ","saltamos ","excavamos ","nos escapamos ",
            "dormimos ","avanzamos ","preguntamos ","colgamos ","contamos ",
            "reimos ","batallamos ","nadamos ","nos escondimos ","entrenamos "
    };

    // verbos intransitivos tercera persona eng
    String vib3[] = {
            "sings ", "slides ", "cries ", "concentrates ", "doubts ",
            "marches ", "dies ", "jumps ", "digs ", "escapes ",
            "sleeps ", "advances ", "wonders ", "hangs ", "counts ",
            "laughs ", "struggles ", "swims ", "hides ", "trains "
    };
    // verbos intransitivos base tercera persona esp
    String vib3esp[] = {
            "canta ", "se desliza ", "llora ", "se concentra ", "duda ", "marcha ",
            "muere ", "salta ", "excava ", "se escapa ", "duerme ", "avanza ",
            "se pregunta ", "cuelga ", "cuenta ", "ríe ", "batalla ", "nada ",
            "se esconde ", "entrena "
    };

    // continuos intransitivos inglés
    String vib3cont[] = {
            "singing ", "sliding ", "crying ", "concentrating ", "doubting ", "marching ",
            "dying ", "jumping ", "digging ", "escaping ", "sleeping ", "advancing ",
            "wondering ", "hanging ", "counting ", "laughing ", "struggling ", "swimming ",
            "hiding ", "training "
    };
    // participio intransitivo esp
    String vib3contesp[] = {
            "cantando ", "deslizandose ", "llorando ", "concentrando ", "dudando ", "marchando ",
            "muriendo ", "saltando ", "excavando ", "escapando ", "durmiendo ", "avanzando ",
            "preguntando ", "colgando ", "contando ", "riendo ", "batallando ", "nadando ",
            "escondeiendo ", "entrenando "
    };

    //participio intransitivo inglés
    String viparticiple[] = {
            "sung ", "slidden ", "cryed ", "concentrated ", "doubted ", "marched ",
            "died ", "jumped ", "dug ", "escaped ", "slept ", "advanced ",
            "wondered ", "hanged ", "counted ", "laughed ", "struggled ", "swum ",
            "hid ", "trained "
    };
    String vibparticipiosp[] = {
            "cantado ", "deslizado ", "llorado ", "concentrado ", "dudado ", "marchado ",
            "muerto ", "saltado ", "excavado ", "escapado ", "dormido ", "avanzado ",
            "preguntado ", "colgado ", "contado ", "reido ", "batallado ", "nadado ",
            "escondido ", "entrenado "
    };

    //verbos intransitivos base primera
    String vib1[] = {
            "canto ", "me deslizo ", "lloro ", "me concentro ", "dudo ", "marcho ",
            "muero ", "salto ", "excavo ", "me escapo ", "duermo ", "avanzo ",
            "me pregunto ", "cuelgo ", "cuento ", "me rió ", "batallo ", "nado ",
            "me escondo ", "entreno "
    };
    //verbos intransitivos base segunda
    String vib2[] = {
            "cantas ", "te deslizas ", "lloras ", "te concentras ", "dudas ", "marchas ",
            "mueres ", "saltas ", "excavas ", "te escapas ", "duermes ", "avanzas ",
            "te preguntas ", "cuelgas ", "cuentas ", "te ríes ", "batallas ", "nadas ",
            "te escondes ", "entrenas "
    };
    String vib3p[]={
            "canta ", "se desliza ", "llora ", "se concentra ", "duda ", "marcha ",
            "muere ", "salta ", "excava ", "se escapa ", "duerme ", "avanza ",
            "se pregunta ", "cuelga ", "cuenta ", "se ríe ", "batalla ", "nada ",
            "se esconde ", "entrena "
    };
    //verbos intransitivos base tercera plural
    String vib4[] = {
            "cantan ", "se deslizan ", "lloran ", "se concentran ", "dudan ", "marchan ",
            "mueren ", "saltan ", "excavan ", "se escapan ", "duermen ", "avanzan ",
            "se preguntan ", "cuelgan ", "cuentan ", "se ríen ", "batallan ", "nadan ",
            "se esconden ", "entrenan "
    };
    //verbos intransitivos base nosotros
    String vibnos[] = {
            "cantamos ", "nos deslizamos ", "lloramos ", "nos concentramos ", "dudamos ", "marchamos ",
            "morimos ", "saltamos ", "excavamos ", "nos escapamos ", "dormimos ", "avanzamos ",
            "nos preguntamos ", "colgamos ", "contamos ", "nos reímos ", "batallamos ", "nadamos ",
            "nos escondemos ", "entrenamos "
    };

    //verbo intrasitivo base futuro primer persona
    String vib1f[] = {
            "cantaré ", "me deslizaré ", "lloraré ", "me concentré ", "dudaré ", "marcharé ",
            "moriré ", "saltaré ", "excavaré ", "me escaparé ", "dormiré ", "avanzaré ",
            "me preguntaré ", "colgaré ", "contaré ", "me reiré ", "batallaré ", "nadaré ",
            "me esconderé ", "entrenaré "
    };
    //verbo intrasitivo base futuro segunda persona
    String vib2f[] = {
            "cantarás ", "te deslizarás ", "llorarás ", "te concentrarás ", "dudarás ", "marcharás ",
            "morirás ", "saltarás ", "excavarás ", "te escaparás ", "dormirás ", "avanzarás ",
            "te preguntarás ", "colgarás ", "contarás ", "te reirás ", "batallarás ", "nadarás ",
            "te esconderás ", "entrenarás "
    };
    //verbo intranstivo base futuro tercera persona
    String vib3f[] = {
            "cantará ", "se deslizará ", "llorará ", "se concentrará ", "dudará ", "marchará ",
            "morirá ", "saltará ", "excavará ", "se escapará ", "dormirá ", "avanzará ",
            "se preguntará ", "colgará ", "contará ", "se reirá ", "batallará ", "nadará ",
            "se esconderá ", "entrenará "
    };
    //verbo intransitivo base futuro cuarta persona
    String vib4f[] = {
            "cantarán ", "se deslizarán ", "llorarán ", "se concentrarán ", "dudarán ", "marcharán ",
            "morirán ", "saltarán ", "excavarán ", "se escaparán ", "dormirán ", "avanzarán ",
            "se preguntarán ", "colgarán ", "contarán ", "se reirán ", "batallarán ", "nadarán ",
            "se esconderán ", "entrenarán "
    };
    //verbo intransitivo base futuro nosotros
    String vibfnos[] = {
            "cantaremos ", "nos deslizaremos ", "lloraremos ", "nos concentraremos ",
            "dudaremos ", "marcharemos ", "moriremos ", "saltaremos ", "excavaremos ", "nos escaparemos ",
            "dormiremos ", "avanzaremos ", "nos preguntaremos ", "colgaremos ", "contaremos ", "nos reiremos ",
            "nos batallaremos ", "nadaremos ", "esconderemos ", "entrenaremos "
    };

    // subjuntivos intransitivos
    String vib1s[] = {
            "cante ", "me deslice ", "llore ", "me concentre ", "dude ", "marche ",
            "muera ", "salte ", "excave ", "me escape ", "duerma ", "avance ",
            "me pregunte ", "cuelgue ", "cuente ", "me ría ", "batalle ", "nade ",
            "me esconda ", "entrene "
    };
    String vib2s[] = {
            "cantes ", "te deslices ", "llores ", "te concentres ", "dudes ", "marches ",
            "mueras ", "saltes ", "excaves ", "te escapes ", "duermas ", "avances ",
            "te preguntes ", "cuelgues ", "cuentes ", "te rías ", "batalles ", "nades ",
            "te escondas ", "entrenes "
    };
    String vib3s[] = {
            "cante ", "se deslice ", "llore ", "se concentre ", "dude ", "marche ",
            "muera ", "salte ", "excave ", "se escape ", "duerma ", "avance ",
            "se pregunte ", "cuelgue ", "cuente ", "se ría ", "batalle ", "nade ",
            "se esconda ", "entrene "
    };
    String vib4s[] = {
            "canten ", "se deslicen ", "lloren ", "se concentren ", "duden ", "marchen ",
            "mueran ", "salten ", "excaven ", "se escapen ", "duerman ", "avancen ",
            "se pregunten ", "cuelguen ", "cuenten ", "se rían ", "batallen ", "naden ",
            "se escondan ", "entrenen "
    };
    String vib5s[] = {
            "cantemos ", "nos deslicemos ", "lloremos ", "nos concentremos ", "dudemos ", "marchemos ",
            "muramos ", "saltemos ", "excavemos ", "nos escapemos ", "durmamos ", "avancemos ",
            "nos preguntemos ", "colguemos ", "contemos ", "nos ríamos ", "batallemos ", "nademos ",
            "nos escondamos ", "entrenemos "
    };

    // hipoteticos intransitivos
    String vib1w[] = {
            "cantaría ", "me deslizaría ", "lloraría ", "me concentraría ", "dudaría ", "marcharía ",
            "moriría ", "saltaría ", "excavaría ", "me escaparía ", "dormiría ", "avanzaría ",
            "me preguntaría ", "colgaría ", "contaría ", "me reiría ", "batallaría ", "nadaría ",
            "me escondería ", "entrenaría "
    };
    String vib2w[] = {
            "cantarías ", "te deslizarías ", "llorarías ", "te concentrarías ", "dudarías ", "marcharías ",
            "morirías ", "saltarías ", "excavarías ", "te escaparías ", "dormirías ", "avanzarías ",
            "te preguntarías ", "colgarías ", "contarías ", "te reirías ", "batallarías ", "nadarías ",
            "te esconderías ", "entrenarías "
    };
    String vib3w[] = {
            "cantaría ", "se deslizaría ", "lloraría ", "se concentraría ", "dudaría ", "marcharía ",
            "moriría ", "saltaría ", "excavaría ", "se escaparía ", "dormiría ", "avanzaría ",
            "se preguntaría ", "colgaría ", "contaría ", "se reiría ", "batallaría ", "nadaría ",
            "se escondería ", "entrenaría "
    };
    String vib4w[] = {
            "cantarían ", "se deslizarían ", "llorarían ", "se concentrarían ", "dudarían ", "marcharían ",
            "morirían ", "saltarían ", "excavarían ", "se escaparían ", "dormirían ", "avanzarían ",
            "se preguntarían ", "colgarían ", "contarían ", "se reirían ", "batallarían ", "nadarían ",
            "se esconderían ", "entrenarían "
    };
    String vib5w[] = {
            "cantaríamos ", "nos deslizaríamos ", "lloraríamos ", "nos concentraríamos ", "dudaríamos ", "marcharíamos ",
            "moriríamos ", "saltaríamos ", "excavaríamos ", "nos escaparíamos ", "dormiríamos ", "avanzaríamos ",
            "nos preguntaríamos ", "colgaríamos ", "contaríamos ", "nos reiríamos ", "batallaríamos ", "nadaríamos ",
            "nos esconderíamos ", "entrenaríamos "
    };
    ...
    public void randstarter() {
        ...
        rand3 = (int) (Math.random() * singSpecial.length);
        rand4 = (int) (Math.random() * singSpecial[rand3].length);
        r5 = (int) (Math.random() * slideSpecial.length);
        r6 = (int) (Math.random() * slideSpecial[r5].length);
        r7 = (int) (Math.random() * crySpecial.length);
        r8 = (int) (Math.random() * crySpecial[r7].length);
        r9 = (int) (Math.random() * concentrateSpecial.length);
        r10 = (int) (Math.random() * concentrateSpecial[r9].length);
        r11 = (int) (Math.random() * doubtSpecial.length);
        r12 = (int) (Math.random() * doubtSpecial[r11].length);
        r13 = (int) (Math.random() * marchSpecial.length);
        r14 = (int) (Math.random() * marchSpecial[r13].length);
        r15 = (int) (Math.random() * dieSpecial.length);
        r16 = (int) (Math.random() * dieSpecial[r15].length);
        r17 = (int) (Math.random() * jumpSpecial.length);
        r18 = (int) (Math.random() * jumpSpecial[r17].length);
        r19 = (int) (Math.random() * digSpecial.length);
        r20 = (int) (Math.random() * digSpecial[r19].length);
        r21 = (int) (Math.random() * escapeSpecial.length);
        r22 = (int) (Math.random() * escapeSpecial[r21].length);
        r23 = (int) (Math.random() * sleepSpecial.length);
        r24 = (int) (Math.random() * sleepSpecial[r23].length);
        r25 = (int) (Math.random() * advanceSpecial.length);
        r26 = (int) (Math.random() * advanceSpecial[r25].length);
        r27 = (int) (Math.random() * wonderSpecial.length);
        r28 = (int) (Math.random() * wonderSpecial[r27].length);
        r29 = (int) (Math.random() * hangSpecial.length);
        r30 = (int) (Math.random() * hangSpecial[r29].length);
        r31 = (int) (Math.random() * countSpecial.length);
        r32 = (int) (Math.random() * countSpecial[r31].length);
        r33 = (int) (Math.random() * laughSpecial.length);
        r34 = (int) (Math.random() * laughSpecial[r33].length);
        r35 = (int) (Math.random() * struggleSpecial.length);
        r36 = (int) (Math.random() * struggleSpecial[r35].length);
        r37 = (int) (Math.random() * swimSpecial.length);
        r38 = (int) (Math.random() * swimSpecial[r37].length);
        r39 = (int) (Math.random() * hideSpecial.length);
        r40 = (int) (Math.random() * hideSpecial[r39].length);
        r41 = (int) (Math.random() * trainSpecial.length);
        r42 = (int) (Math.random() * trainSpecial[r41].length);
    }
    ...
    public void arraySpe(){
        ...
        switch (temp){
            case "sing ":
                arrayEsp = cantarSpecial[rand3][rand4];
                arrayEng = singSpecial[rand3][rand4];

                break;
            case "slide ":
                arrayEsp = deslizarseSpecial[r5][r6];
                arrayEng = slideSpecial[r5][r6];

                break;
            case "cry ":
                arrayEsp = llorarSpecial[r7][r8];
                arrayEng = crySpecial[r7][r8];

                break;
            case "concentrate ":
                arrayEsp = concentrarseSpecial[r9][r10];
                arrayEng = concentrateSpecial[r9][r10];

                break;
            case "doubt ":
                arrayEsp = nadarSpecial[r11][r12];
                arrayEng = doubtSpecial[r11][r12];

                break;
            case "march ":
                arrayEsp = marcharSpecial[r13][r14];
                arrayEng = marchSpecial[r13][r14];

                break;
            case "die ":
                arrayEsp = morirSpecial[r15][r16];
                arrayEng = dieSpecial[r15][r16];

                break;
            case "jump ":
                arrayEsp = saltarSpecial[r17][r18];
                arrayEng = jumpSpecial[r17][r18];

                break;
            case "dig ":
                arrayEsp = excavarSpecial[r19][r20];
                arrayEng = digSpecial[r19][r20];

                break;
            case "escape ":
                arrayEsp = escaparseSpecial[r21][r22];
                arrayEng = escapeSpecial[r21][r22];

                break;
            case "sleep ":
                arrayEsp = dormirSpecial[r23][r24];
                arrayEng = sleepSpecial[r23][r24];

                break;
            case "advance ":
                arrayEsp = avanzarSpecial[r25][r26];
                arrayEng = advanceSpecial[r25][r26];

                break;
            case "wonder ":
                arrayEsp = preguntarseSpecial[r27][r28];
                arrayEng = wonderSpecial[r27][r28];

                break;
            case "hang ":
                arrayEsp = colgarSpecial[r29][r30];
                arrayEng = hangSpecial[r29][r30];

                break;
            case "count ":
                arrayEsp = contarSpecial[r31][r32];
                arrayEng = countSpecial[r31][r32];

                break;
            case "laugh ":
                arrayEsp = reírseSpecial[r33][r34];
                arrayEng = laughSpecial[r33][r34];

                break;
            case "struggle ":
                arrayEsp = batallarSpecial[r35][r36];
                arrayEng = struggleSpecial[r35][r36];

                break;
            case "swim ":
                arrayEsp = nadarSpecial[r37][r38];
                arrayEng = swimSpecial[r37][r38];

                break;
            case "hide ":
                arrayEsp = esconderSpecial[r39][r40];
                arrayEng = hideSpecial[r39][r40];
            ...
            if (verbs.equals(temp)) {
                switch (neg) {
                    case 0:
                        ...
                        sp6 = "ellos " + "son capaces de " + vibesp[rand];
                        eng6 = "they are " + "able to " + vib[rand];
                        eng62 = "they're " + "able to " + vib[rand];

                        sp7 = "nosotros " + "somos capaces de " + vibesp[rand];
                    ...
                    case 1:
                        ...
                        sp6 = "ellos no " + "son capaces de " + vibesp[rand];
                        eng6 = "they are not " + "able to " + vib[rand];
                        eng62 = "they're not " + "able to " + vib[rand];

                        sp7 = "nosotros no " + "somos capaces de " + vibesp[rand];
            ...
            if (verbs.equals(temp)) {
                switch (neg) {
                    case 0:
                        ...
                        sp6 = "ellos " + "son capaces de " + vibesp[rand] + arrayEsp;
                        eng6 = "they are " + "able to " + vib[rand] + arrayEng;
                        eng62 = "they're " + "able to " + vib[rand] + arrayEng;

                        sp7 = "nosotros " + "somos capaces de " + vibesp[rand] + arrayEsp;
                    ...
                    case 1:
                        ...
                        sp6 = "ellos no " + "son capaces de " + vibesp[rand] + arrayEsp;
                        eng6 = "they are not " + "able to " + vib[rand] + arrayEng;
                        eng62 = "they're not " + "able to " + vib[rand] + arrayEng;

                        sp7 = "nosotros no " + "somos capaces de " + vibesp[rand] + arrayEsp;
    ...
    /*public void intporprep() {
        ...
        switch (temp) {
            case "cry ":
                switch (neg) {
                    case 0:
                        sp1 = llorarSpecial[rand3][rand4]+"yo " + vib1[rand] ;
                        eng1 = "I " + vib[rand] + crySpecial[rand3][rand4];
                        sp2 =llorarSpecial[rand3][rand4]+ "tú " + vib2[rand] ;
                        eng2 = "you " + vib[rand] + crySpecial[rand3][rand4];
                        sp3 =llorarSpecial[rand3][rand4]+ "él " + vib3esp[rand] ;
                        eng3 = "he " + vib3p[rand] + crySpecial[rand3][rand4];
                        sp4 =llorarSpecial[rand3][rand4]+ "ella " + vib3esp[rand] ;
                        eng4 = "she " + vib3p[rand] + crySpecial[rand3][rand4];
                        sp5 = llorarSpecial[rand3][rand4]+"eso " + vib3esp[rand] ;
                        eng5 = "it " + vib3p[rand] + crySpecial[rand3][rand4];
                        sp6 =llorarSpecial[rand3][rand4]+ "ellos " + vib4[rand] ;
                        eng6 = "they " + vib[rand] + crySpecial[rand3][rand4];
                        sp7 =llorarSpecial[rand3][rand4]+ "nosotros " + vibnos[rand];
                        eng7 = "we " + vib[rand] + crySpecial[rand3][rand4];
                        break;
                    case 1:
                        sp1 =llorarSpecial[rand3][rand4]+ "yo " + "no " + vib1[rand] ;
                        eng1 = "I " + "don't " + vib[rand] + crySpecial[rand3][rand4];
                        sp2 =llorarSpecial[rand3][rand4]+ "tú " + "no " + vib2[rand] ;
                        eng2 = "you " + "don't " + vib[rand] + crySpecial[rand3][rand4];
                        sp3 = llorarSpecial[rand3][rand4]+"él " + "no " + vib3esp[rand] ;
                        eng3 = "he " + "doesn't " + vib[rand] + crySpecial[rand3][rand4];
                        sp4 = llorarSpecial[rand3][rand4]+"ella " + "no " + vib3esp[rand] ;
                        eng4 = "she " + "doesn't " + vib[rand] + crySpecial[rand3][rand4];
                        sp5 =llorarSpecial[rand3][rand4]+ "eso " + "no " + vib3esp[rand] ;
                        eng5 = "it " + "doesn't " + vib[rand] + crySpecial[rand3][rand4];
                        sp6 =llorarSpecial[rand3][rand4]+ "ellos " + "no " + vib4[rand] ;
                        eng6 = "they " + "don't " + vib[rand] + crySpecial[rand3][rand4];
                        sp7 = llorarSpecial[rand3][rand4]+"nosotros " + "no " + vibnos[rand];
                        eng7 = "we " + "don't " + vib[rand] + crySpecial[rand3][rand4];
                        break;
                }
                break;
            case "concentrate ":
                switch (neg) {
                    case 0:
                        sp1 = concentrarseSpecial[r5][r6]+"yo " + vib1[rand] ;
                        eng1 = "I " + vib[rand] + concentrateSpecial[r5][r6];
                        sp2 =concentrarseSpecial[r5][r6]+ "tú " + vib2[rand] ;
                        eng2 = "you " + vib[rand] + concentrateSpecial[r5][r6];
                        sp3 =concentrarseSpecial[r5][r6]+ "él " + vib3esp[rand] ;
                        eng3 = "he " + vib3p[rand] + concentrateSpecial[r5][r6];
                        sp4 =concentrarseSpecial[r5][r6]+ "ella " + vib3esp[rand] ;
                        eng4 = "she " + vib3p[rand] + concentrateSpecial[r5][r6];
                        sp5 = concentrarseSpecial[r5][r6]+"eso " + vib3esp[rand] ;
                        eng5 = "it " + vib3p[rand] + concentrateSpecial[r5][r6];
                        sp6 =concentrarseSpecial[r5][r6]+ "ellos " + vib4[rand] ;
                        eng6 = "they " + vib[rand] + concentrateSpecial[r5][r6];
                        sp7 =concentrarseSpecial[r5][r6]+ "nosotros " + vibnos[rand];
                        eng7 = "we " + vib[rand] + concentrateSpecial[r5][r6];
                        break;
                    case 1:
                        sp1 =concentrarseSpecial[r5][r6]+ "yo " + "no " + vib1[rand] ;
                        eng1 = "I " + "don't " + vib[rand] + concentrateSpecial[r5][r6];
                        sp2 =concentrarseSpecial[r5][r6]+ "tú " + "no " + vib2[rand] ;
                        eng2 = "you " + "don't " + vib[rand] + concentrateSpecial[r5][r6];
                        sp3 = concentrarseSpecial[r5][r6]+"él " + "no " + vib3esp[rand] ;
                        eng3 = "he " + "doesn't " + vib[rand] + concentrateSpecial[r5][r6];
                        sp4 = concentrarseSpecial[r5][r6]+"ella " + "no " + vib3esp[rand] ;
                        eng4 = "she " + "doesn't " + vib[rand] + concentrateSpecial[r5][r6];
                        sp5 =concentrarseSpecial[r5][r6]+ "eso " + "no " + vib3esp[rand] ;
                        eng5 = "it " + "doesn't " + vib[rand] + concentrateSpecial[r5][r6];
                        sp6 =concentrarseSpecial[r5][r6]+ "ellos " + "no " + vib4[rand] ;
                        eng6 = "they " + "don't " + vib[rand] + concentrateSpecial[r5][r6];
                        sp7 = concentrarseSpecial[r5][r6]+"nosotros " + "no " + vibnos[rand];
                        eng7 = "we " + "don't " + vib[rand] + concentrateSpecial[r5][r6];
                        break;
                } // last one
                break;
            case "doubt ":
                switch (neg) {
                    case 0:
                        sp1 = "yo " + vib1[rand] + nadarSpecial[r7][r8];
                        eng1 = "I " + vib[rand] + doubtSpecial[r7][r8];

                        sp2 = "tú " + vib2[rand] + nadarSpecial[r7][r8];
                        eng2 = "you " + vib[rand] + doubtSpecial[r7][r8];

                        sp3 = "él " + vib3esp[rand] + nadarSpecial[r7][r8];
                        eng3 = "he " + vib3p[rand] + doubtSpecial[r7][r8];

                        sp4 = "ella " + vib3esp[rand] + nadarSpecial[r7][r8];
                        eng4 = "she " + vib3p[rand] + doubtSpecial[r7][r8];

                        sp5 = "eso " + vib3esp[rand] + nadarSpecial[r7][r8];
                        eng5 = "it " + vib3p[rand] + doubtSpecial[r7][r8];

                        sp6 = "ellos " + vib4[rand] + nadarSpecial[r7][r8];
                        eng6 = "they " + vib[rand] + doubtSpecial[r7][r8];

                        sp7 = "nosotros " + vibnos[rand] + nadarSpecial[r7][r8];
                        eng7 = "we " + vib[rand] + doubtSpecial[r7][r8];
                        break;
                    case 1:
                        sp1 = "yo " + "no " + vib1[rand] + nadarSpecial[r7][r8];
                        eng1 = "I " + "don't " + vib[rand] + doubtSpecial[r7][r8];

                        sp2 = "tú " + "no " + vib2[rand] + nadarSpecial[r7][r8];
                        eng2 = "you " + "don't " + vib[rand] + doubtSpecial[r7][r8];
                        sp3 = "él " + "no " + vib3esp[rand] + nadarSpecial[r7][r8];
                        eng3 = "he " + "doesn't " + vib[rand] + doubtSpecial[r7][r8];
                        sp4 = "ella " + "no " + vib3esp[rand] + nadarSpecial[r7][r8];
                        eng4 = "she " + "doesn't " + vib[rand] + doubtSpecial[r7][r8];

                        sp5 = "eso " + "no " + vib3esp[rand] + nadarSpecial[r7][r8];
                        eng5 = "it " + "doesn't " + vib[rand] + doubtSpecial[r7][r8];

                        sp6 = "ellos " + "no " + vib4[rand] + nadarSpecial[r7][r8];
                        eng6 = "they " + "don't " + vib[rand] + doubtSpecial[r7][r8];

                        sp7 = "nosotros " + "no " + vibnos[rand] + nadarSpecial[r7][r8];
                        eng7 = "we " + "don't " + vib[rand] + doubtSpecial[r7][r8];
                        break;
                }
                break;
            case "march ":
                switch (neg) {
                    case 0:
                        sp1 = "yo " + vib1[rand] + marcharSpecial[r9][r10];
                        eng1 = "I " + vib[rand] + marchSpecial[r9][r10];

                        sp2 = "tú " + vib2[rand] + marcharSpecial[r9][r10];
                        eng2 = "you " + vib[rand] + marchSpecial[r9][r10];

                        sp3 = "él " + vib3esp[rand] + marcharSpecial[r9][r10];
                        eng3 = "he " + vib3p[rand] + marchSpecial[r9][r10];
                        sp4 = "ella " + vib3esp[rand] + marcharSpecial[r9][r10];
                        eng4 = "she " + vib3p[rand] + marchSpecial[r9][r10];
                        sp5 = "eso " + vib3esp[rand] + marcharSpecial[r9][r10];
                        eng5 = "it " + vib3p[rand] + marchSpecial[r9][r10];
                        sp6 = "ellos " + vib4[rand] + marcharSpecial[r9][r10];
                        eng6 = "they " + vib[rand] + marchSpecial[r9][r10];
                        sp7 = "nosotros " + vibnos[rand] + marcharSpecial[r9][r10];
                        eng7 = "we " + vib[rand] + marchSpecial[r9][r10];
                        break;
                    case 1:
                        sp1 = "yo " + "no " + vib1[rand] + marcharSpecial[r9][r10];
                        eng1 = "I " + "don't " + vib[rand] + marchSpecial[r9][r10];
                        sp2 = "tú " + "no " + vib2[rand] + marcharSpecial[r9][r10];
                        eng2 = "you " + "don't " + vib[rand] + marchSpecial[r9][r10];
                        sp3 = "él " + "no " + vib3esp[rand] + marcharSpecial[r9][r10];
                        eng3 = "he " + "doesn't " + vib[rand] + marchSpecial[r9][r10];
                        sp4 = "ella " + "no " + vib3esp[rand] + marcharSpecial[r9][r10];
                        eng4 = "she " + "doesn't " + vib[rand] + marchSpecial[r9][r10];
                        sp5 = "eso " + "no " + vib3esp[rand] + marcharSpecial[r9][r10];
                        eng5 = "it " + "doesn't " + vib[rand] + marchSpecial[r9][r10];
                        sp6 = "ellos " + "no " + vib4[rand] + marcharSpecial[r9][r10];
                        eng6 = "they " + "don't " + vib[rand] + marchSpecial[r9][r10];
                        sp7 = "nosotros " + "no " + vibnos[rand] + marcharSpecial[r9][r10];
                        eng7 = "we " + "don't " + vib[rand] + marchSpecial[r9][r10];
                        break;
                }
                break;
            case "die ":
                switch (neg) {
                    case 0:
                        sp1 = "yo " + vib1[rand] + morirSpecial[r11][r12];
                        eng1 = "I " + vib[rand] + dieSpecial[r11][r12];

                        sp2 = "tú " + vib2[rand] + morirSpecial[r11][r12];
                        eng2 = "you " + vib[rand] + dieSpecial[r11][r12];
                        sp3 = "él " + vib3esp[rand] + morirSpecial[r11][r12];
                        eng3 = "he " + vib3p[rand] + dieSpecial[r11][r12];
                        sp4 = "ella " + vib3esp[rand] + morirSpecial[r11][r12];
                        eng4 = "she " + vib3p[rand] + dieSpecial[r11][r12];
                        sp5 = "eso " + vib3esp[rand] + morirSpecial[r11][r12];
                        eng5 = "it " + vib3p[rand] + dieSpecial[r11][r12];
                        sp6 = "ellos " + vib4[rand] + morirSpecial[r11][r12];
                        eng6 = "they " + vib[rand] + dieSpecial[r11][r12];
                        sp7 = "nosotros " + vibnos[rand] + morirSpecial[r11][r12];
                        eng7 = "we " + vib[rand] + dieSpecial[r11][r12];
                        break;

                    case 1:
                        sp1 = "yo " + "no " + vib1[rand] + morirSpecial[r11][r12];
                        eng1 = "I " + "don't " + vib[rand] + dieSpecial[r11][r12];
                        sp2 = "tú " + "no " + vib2[rand] + morirSpecial[r11][r12];
                        eng2 = "you " + "don't " + vib[rand] + dieSpecial[r11][r12];
                        sp3 = "él " + "no " + vib3esp[rand] + morirSpecial[r11][r12];
                        eng3 = "he " + "doesn't " + vib[rand] + dieSpecial[r11][r12];
                        sp4 = "ella " + "no " + vib3esp[rand] + morirSpecial[r11][r12];
                        eng4 = "she " + "doesn't " + vib[rand] + dieSpecial[r11][r12];
                        sp5 = "eso " + "no " + vib3esp[rand] + morirSpecial[r11][r12];
                        eng5 = "it " + "doesn't " + vib[rand] + dieSpecial[r11][r12];
                        sp6 = "ellos " + "no " + vib4[rand] + morirSpecial[r11][r12];
                        eng6 = "they " + "don't " + vib[rand] + dieSpecial[r11][r12];
                        sp7 = "nosotros " + "no " + vibnos[rand] + morirSpecial[r11][r12];
                        eng7 = "we " + "don't " + vib[rand] + dieSpecial[r11][r12];
                        break;
                }
                break;
            case "jump ":
                switch (neg) {
                    case 0:
                        sp1 = "yo " + vib1[rand] + saltarSpecial[r13][r14];
                        eng1 = "I " + vib[rand] + jumpSpecial[r13][r14];
                        sp2 = "tú " + vib2[rand] + saltarSpecial[r13][r14];
                        eng2 = "you " + vib[rand] + jumpSpecial[r13][r14];
                        sp3 = "él " + vib3esp[rand] + saltarSpecial[r13][r14];
                        eng3 = "he " + vib3p[rand] + jumpSpecial[r13][r14];
                        sp4 = "ella " + vib3esp[rand] + saltarSpecial[r13][r14];
                        eng4 = "she " + vib3p[rand] + jumpSpecial[r13][r14];

                        sp5 = "eso " + vib3esp[rand] + saltarSpecial[r13][r14];
                        eng5 = "it " + vib3p[rand] + jumpSpecial[r13][r14];
                        sp6 = "ellos " + vib4[rand] + saltarSpecial[r13][r14];
                        eng6 = "they " + vib[rand] + jumpSpecial[r13][r14];
                        sp7 = "nosotros " + vibnos[rand] + saltarSpecial[r13][r14];
                        eng7 = "we " + vib[rand] + jumpSpecial[r13][r14];
                        break;
                    case 1:
                        sp1 = "yo " + "no " + vib1[rand] + saltarSpecial[r13][r14];
                        eng1 = "I " + "don't " + vib[rand] + jumpSpecial[r13][r14];
                        sp2 = "tú " + "no " + vib2[rand] + saltarSpecial[r13][r14];
                        eng2 = "you " + "don't " + vib[rand] + jumpSpecial[r13][r14];

                        sp3 = "él " + "no " + vib3esp[rand] + saltarSpecial[r13][r14];
                        eng3 = "he " + "doesn't " + vib[rand] + jumpSpecial[r13][r14];
                        sp4 = "ella " + "no " + vib3esp[rand] + saltarSpecial[r13][r14];
                        eng4 = "she " + "doesn't " + vib[rand] + jumpSpecial[r13][r14];
                        sp5 = "eso " + "no " + vib3esp[rand] + saltarSpecial[r13][r14];
                        eng5 = "it " + "doesn't " + vib[rand] + jumpSpecial[r13][r14];
                        sp6 = "ellos " + "no " + vib4[rand] + saltarSpecial[r13][r14];
                        eng6 = "they " + "don't " + vib[rand] + jumpSpecial[r13][r14];
                        sp7 = "nosotros " + "no " + vibnos[rand] + saltarSpecial[r13][r14];
                        eng7 = "we " + "don't " + vib[rand] + jumpSpecial[r13][r14];
                        break;
                }
                break;
            case "dig ":
                switch (neg) {
                    case 0:
                        sp1 = "yo " + vib1[rand] + excavarSpecial[r15][r16];
                        eng1 = "I " + vib[rand] + dieSpecial[r15][r16];
                        sp2 = "tú " + vib2[rand] + excavarSpecial[r15][r16];
                        eng2 = "you " + vib[rand] + dieSpecial[r15][r16];
                        sp3 = "él " + vib3esp[rand] + excavarSpecial[r15][r16];
                        eng3 = "he " + vib3p[rand] + dieSpecial[r15][r16];
                        sp4 = "ella " + vib3esp[rand] + excavarSpecial[r15][r16];
                        eng4 = "she " + vib3p[rand] + dieSpecial[r15][r16];
                        sp5 = "eso " + vib3esp[rand] + excavarSpecial[r15][r16];
                        eng5 = "it " + vib3p[rand] + dieSpecial[r15][r16];
                        sp6 = "ellos " + vib4[rand] + excavarSpecial[r15][r16];
                        eng6 = "they " + vib[rand] + dieSpecial[r15][r16];
                        sp7 = "nosotros " + vibnos[rand] + excavarSpecial[r15][r16];
                        eng7 = "we " + vib[rand] + dieSpecial[r15][r16];
                        break;
                    case 1:
                        sp1 = "yo " + "no " + vib1[rand] + excavarSpecial[r15][r16];
                        eng1 = "I " + "don't " + vib[rand] + dieSpecial[r15][r16];
                        sp2 = "tú " + "no " + vib2[rand] + excavarSpecial[r15][r16];
                        eng2 = "you " + "don't " + vib[rand] + dieSpecial[r15][r16];
                        sp3 = "él " + "no " + vib3esp[rand] + excavarSpecial[r15][r16];
                        eng3 = "he " + "doesn't " + vib[rand] + dieSpecial[r15][r16];
                        sp4 = "ella " + "no " + vib3esp[rand] + excavarSpecial[r15][r16];
                        eng4 = "she " + "doesn't " + vib[rand] + dieSpecial[r15][r16];
                        sp5 = "eso " + "no " + vib3esp[rand] + excavarSpecial[r15][r16];
                        eng5 = "it " + "doesn't " + vib[rand] + dieSpecial[r15][r16];
                        sp6 = "ellos " + "no " + vib4[rand] + excavarSpecial[r15][r16];
                        eng6 = "they " + "don't " + vib[rand] + dieSpecial[r15][r16];
                        sp7 = "nosotros " + "no " + vibnos[rand] + excavarSpecial[r15][r16];
                        eng7 = "we " + "don't " + vib[rand] + dieSpecial[r15][r16];
                        break;
                }
                break;
            case "escape ":
                switch (neg) {
                    case 0:
                        sp1 = "yo " + vib1[rand] + escaparseSpecial[r17][r18];
                        eng1 = "I " + vib[rand] + digSpecial[r17][r18];
                        sp2 = "tú " + vib2[rand] + escaparseSpecial[r17][r18];
                        eng2 = "you " + vib[rand] + digSpecial[r17][r18];
                        sp3 = "él " + vib3esp[rand] + escaparseSpecial[r17][r18];
                        eng3 = "he " + vib3p[rand] + digSpecial[r17][r18];
                        sp4 = "ella " + vib3esp[rand] + escaparseSpecial[r17][r18];
                        eng4 = "she " + vib3p[rand] + digSpecial[r17][r18];
                        sp5 = "eso " + vib3esp[rand] + escaparseSpecial[r17][r18];
                        eng5 = "it " + vib3p[rand] + digSpecial[r17][r18];
                        sp6 = "ellos " + vib4[rand] + escaparseSpecial[r17][r18];
                        eng6 = "they " + vib[rand] + digSpecial[r17][r18];
                        sp7 = "nosotros " + vibnos[rand] + escaparseSpecial[r17][r18];
                        eng7 = "we " + vib[rand] + digSpecial[r17][r18];
                        break;

                    case 1:
                        sp1 = "yo " + "no " + vib1[rand] + escaparseSpecial[r17][r18];
                        eng1 = "I " + "don't " + vib[rand] + digSpecial[r17][r18];
                        sp2 = "tú " + "no " + vib2[rand] + escaparseSpecial[r17][r18];
                        eng2 = "you " + "don't " + vib[rand] + digSpecial[r17][r18];
                        sp3 = "él " + "no " + vib3esp[rand] + escaparseSpecial[r17][r18];
                        eng3 = "he " + "doesn't " + vib[rand] + digSpecial[r17][r18];
                        sp4 = "ella " + "no " + vib3esp[rand] + escaparseSpecial[r17][r18];
                        eng4 = "she " + "doesn't " + vib[rand] + digSpecial[r17][r18];
                        sp5 = "eso " + "no " + vib3esp[rand] + escaparseSpecial[r17][r18];
                        eng5 = "it " + "doesn't " + vib[rand] + digSpecial[r17][r18];
                        sp6 = "ellos " + "no " + vib4[rand] + escaparseSpecial[r17][r18];
                        sp6 = "they " + "don't " + vib[rand] + digSpecial[r17][r18];
                        sp7 = "nosotros " + "no " + vibnos[rand] + escaparseSpecial[r17][r18];
                        eng7 = "we " + "don't " + vib[rand] + digSpecial[r17][r18];
                        break;
                }
                break;
            case "move ":
                switch (neg) {
                    case 0:
                        sp1 = "yo " + vib1[rand] + escapeSpecial[r19][r20];
                        eng1 = "I " + vib[rand] + sleepSpecial[r19][r20];
                        sp2 = "tú " + vib2[rand] + escapeSpecial[r19][r20];
                        eng2 = "you " + vib[rand] + sleepSpecial[r19][r20];
                        sp3 = "él " + vib3esp[rand] + escapeSpecial[r19][r20];
                        eng3 = "he " + vib3p[rand] + sleepSpecial[r19][r20];
                        sp4 = "ella " + vib3esp[rand] + escapeSpecial[r19][r20];
                        eng4 = "she " + vib3p[rand] + sleepSpecial[r19][r20];
                        sp5 = "eso " + vib3esp[rand] + escapeSpecial[r19][r20];
                        eng5 = "it " + vib3p[rand] + sleepSpecial[r19][r20];
                        sp6 = "ellos " + vib4[rand] + escapeSpecial[r19][r20];
                        eng6 = "they " + vib[rand] + sleepSpecial[r19][r20];
                        sp7 = "nosotros " + vibnos[rand] + escapeSpecial[r19][r20];
                        eng7 = "we " + vib[rand] + sleepSpecial[r19][r20];
                        break;
                    case 1:
                        sp1 = "yo " + "no " + vib1[rand] + escapeSpecial[r19][r20];
                        eng1 = "I " + "don't " + vib[rand] + sleepSpecial[r19][r20];
                        sp2 = "tú " + "no " + vib2[rand] + escapeSpecial[r19][r20];
                        eng2 = "you " + "don't " + vib[rand] + sleepSpecial[r19][r20];
                        sp3 = "él " + "no " + vib3esp[rand] + escapeSpecial[r19][r20];
                        eng3 = "he " + "doesn't " + vib[rand] + sleepSpecial[r19][r20];

                        sp4 = "ella " + "no " + vib3esp[rand] + escapeSpecial[r19][r20];
                        eng4 = "she " + "doesn't " + vib[rand] + sleepSpecial[r19][r20];
                        sp5 = "eso " + "no " + vib3esp[rand] + escapeSpecial[r19][r20];
                        eng5 = "it " + "doesn't " + vib[rand] + sleepSpecial[r19][r20];

                        sp6 = "ellos " + "no " + vib4[rand] + escapeSpecial[r19][r20];
                        eng6 = "they " + "don't " + vib[rand] + sleepSpecial[r19][r20];

                        sp7 = "nosotros " + "no " + vibnos[rand] + escapeSpecial[r19][r20];
                        eng7 = "we " + "don't " + vib[rand] + sleepSpecial[r19][r20];
                        break;
                }
                break;
            case "live ":
                switch (neg) {
                    case 0:
                        ...
                        sp3 = "él " + vib3esp[rand] + vivspecial[r21][r22];
                        eng3 = "he " + vib3p[rand] + livespecial[r21][r22];
                        sp4 = "ella " + vib3esp[rand] + vivspecial[r21][r22];
                        eng4 = "she " + vib3p[rand] + livespecial[r21][r22];
                        sp5 = "eso " + vib3esp[rand] + vivspecial[r21][r22];
                    ...
                    case 1:
                        ...
                        sp3 = "él " + "no " + vib3esp[rand] + vivspecial[r21][r22];
                        eng3 = "he " + "doesn't " + vib[rand] + livespecial[r21][r22];
                        sp4 = "ella " + "no " + vib3esp[rand] + vivspecial[r21][r22];
                        eng4 = "she " + "doesn't " + vib[rand] + livespecial[r21][r22];
                        sp5 = "eso " + "no " + vib3esp[rand] + vivspecial[r21][r22];
            ...
            case "sit ":
                switch (neg) {
                    case 0:
                        ...
                        sp3 = "él " + vib3esp[rand] + sentspecial[r23][r24];
                        eng3 = "he " + vib3p[rand] + sitspecial[r23][r24];
                        sp4 = "ella " + vib3esp[rand] + sentspecial[r23][r24];
                        eng4 = "she " + vib3p[rand] + sitspecial[r23][r24];
                        sp5 = "eso " + vib3esp[rand] + sentspecial[r23][r24];
                    ...
                    case 1:
                        ...
                        sp3 = "él " + "no " + vib3esp[rand] + sentspecial[r23][r24];
                        eng3 = "he " + "doesn't " + vib[rand] + sitspecial[r23][r24];
                        sp4 = "ella " + "no " + vib3esp[rand] + sentspecial[r23][r24];
                        eng4 = "she " + "doesn't " + vib[rand] + sitspecial[r23][r24];
                        sp5 = "eso " + "no " + vib3esp[rand] + sentspecial[r23][r24];
            ...
            case "stand ":
                switch (neg) {
                    case 0:
                        ...
                        sp3 = "él " + vib3esp[rand] + parspecial[r25][r26];
                        eng3 = "he " + vib3p[rand] + standspecial[r25][r26];
                        sp4 = "ella " + vib3esp[rand] + parspecial[r25][r26];
                        eng4 = "she " + vib3p[rand] + standspecial[r25][r26];
                        sp5 = "eso " + vib3esp[rand] + parspecial[r25][r26];
                    ...
                    case 1:
                        ...
                        sp3 = "él " + "no " + vib3esp[rand] + parspecial[r25][r26];
                        eng3 = "he " + "doesn't " + vib[rand] + standspecial[r25][r26];
                        sp4 = "ella " + "no " + vib3esp[rand] + parspecial[r25][r26];
                        eng4 = "she " + "doesn't " + vib[rand] + standspecial[r25][r26];
                        sp5 = "eso " + "no " + vib3esp[rand] + parspecial[r25][r26];
            ...
            case "understand ":
                switch (neg) {
                    case 0:
                        ...
                        sp3 = "él " + vib3esp[rand] + entspecial[r27][r28];
                        eng3 = "he " + vib3p[rand] + undspecial[r27][r28];
                        sp4 = "ella " + vib3esp[rand] + entspecial[r27][r28];
                        eng4 = "she " + vib3p[rand] + undspecial[r27][r28];
                        sp5 = "eso " + vib3esp[rand] + entspecial[r27][r28];
                    ...
                    case 1:
                        ...
                        sp3 = "él " + "no " + vib3esp[rand] + entspecial[r27][r28];
                        eng3 = "he " + "doesn't " + vib[rand] + undspecial[r27][r28];
                        sp4 = "ella " + "no " + vib3esp[rand] + entspecial[r27][r28];
                        eng4 = "she " + "doesn't " + vib[rand] + undspecial[r27][r28];
                        sp5 = "eso " + "no " + vib3esp[rand] + entspecial[r27][r28];
            ...
            case "walk ":
                switch (neg) {
                    case 0:
                        ...
                        sp3 = "él " + vib3esp[rand] + camspecial[r29][r30];
                        eng3 = "he " + vib3p[rand] + walkspecial[r29][r30];
                        sp4 = "ella " + vib3esp[rand] + camspecial[r29][r30];
                        eng4 = "she " + vib3p[rand] + walkspecial[r29][r30];
                        sp5 = "eso " + vib3esp[rand] + camspecial[r29][r30];
                    ...
                    case 1:
                        ...
                        sp3 = "él " + "no " + vib3esp[rand] + camspecial[r29][r30];
                        eng3 = "he " + "doesn't " + vib[rand] + walkspecial[r29][r30];
                        sp4 = "ella " + "no " + vib3esp[rand] + camspecial[r29][r30];
                        eng4 = "she " + "doesn't " + vib[rand] + walkspecial[r29][r30];
                        sp5 = "eso " + "no " + vib3esp[rand] + camspecial[r29][r30];
            ...
            case "grow ":
                switch (neg) {
                    case 0:
                        ...
                        sp3 = "él " + vib3esp[rand] + crecspecial[r31][r32];
                        eng3 = "he " + vib3p[rand] + growspecial[r31][r32];
                        sp4 = "ella " + vib3esp[rand] + crecspecial[r31][r32];
                        eng4 = "she " + vib3p[rand] + growspecial[r31][r32];
                        sp5 = "eso " + vib3esp[rand] + crecspecial[r31][r32];
                    ...
                    case 1:
                        ...
                        sp3 = "él " + "no " + vib3esp[rand] + crecspecial[r31][r32];
                        eng3 = "he " + "doesn't " + vib[rand] + growspecial[r31][r32];
                        sp4 = "ella " + "no " + vib3esp[rand] + crecspecial[r31][r32];
                        eng4 = "she " + "doesn't " + vib[rand] + growspecial[r31][r32];
                        sp5 = "eso " + "no " + vib3esp[rand] + crecspecial[r31][r32];
            ...
            case "wait ":
                switch (neg) {
                    case 0:
                        ...
                        sp3 = "él " + vib3esp[rand] + espspecial[r33][r34];
                        eng3 = "he " + vib3p[rand] + waitspecial[r33][r34];
                        sp4 = "ella " + vib3esp[rand] + espspecial[r33][r34];
                        eng4 = "she " + vib3p[rand] + waitspecial[r33][r34];
                        sp5 = "eso " + vib3esp[rand] + espspecial[r33][r34];
                    ...
                    case 1:
                        ...
                        sp3 = "él " + "no " + vib3esp[rand] + espspecial[r33][r34];
                        eng3 = "he " + "doesn't " + vib[rand] + waitspecial[r33][r34];
                        sp4 = "ella " + "no " + vib3esp[rand] + espspecial[r33][r34];
                        eng4 = "she " + "doesn't " + vib[rand] + waitspecial[r33][r34];
                        sp5 = "eso " + "no " + vib3esp[rand] + espspecial[r33][r34];
            ...
            case "die ":
                switch (neg) {
                    case 0:
                        sp1 = "yo " + vib1[rand] + morllorarSpecial[r35][r36];
                        eng1 = "I " + vib[rand] + diespecial[r35][r36];
                        sp2 = "tú " + vib2[rand] + morllorarSpecial[r35][r36];
                        eng2 = "you " + vib[rand] + diespecial[r35][r36];
                        sp3 = "él " + vib3esp[rand] + morllorarSpecial[r35][r36];
                        eng3 = "he " + vib3p[rand] + diespecial[r35][r36];
                        sp4 = "ella " + vib3esp[rand] + morllorarSpecial[r35][r36];
                        eng4 = "she " + vib3p[rand] + diespecial[r35][r36];
                        sp5 = "eso " + vib3esp[rand] + morllorarSpecial[r35][r36];
                        eng5 = "it " + vib3p[rand] + diespecial[r35][r36];
                        sp6 = "ellos " + vib4[rand] + morllorarSpecial[r35][r36];
                        eng6 = "they " + vib[rand] + diespecial[r35][r36];
                        sp7 = "nosotros " + vibnos[rand] + morllorarSpecial[r35][r36];
                        eng7 = "we " + vib[rand] + diespecial[r35][r36];
                        break;
                    case 1:
                        sp1 = "yo " + "no " + vib1[rand] + morllorarSpecial[r35][r36];
                        eng1 = "I " + "don't " + vib[rand] + diespecial[r35][r36];
                        sp2 = "tú " + "no " + vib2[rand] + morllorarSpecial[r35][r36];
                        eng2 = "you " + "don't " + vib[rand] + diespecial[r35][r36];
                        sp3 = "él " + "no " + vib3esp[rand] + morllorarSpecial[r35][r36];
                        eng3 = "he " + "doesn't " + vib[rand] + diespecial[r35][r36];
                        sp4 = "ella " + "no " + vib3esp[rand] + morllorarSpecial[r35][r36];
                        eng4 = "she " + "doesn't " + vib[rand] + diespecial[r35][r36];
                        sp5 = "eso " + "no " + vib3esp[rand] + morllorarSpecial[r35][r36];
                        eng5 = "it " + "doesn't " + vib[rand] + diespecial[r35][r36];
                        sp6 = "ellos " + "no " + vib4[rand] + morllorarSpecial[r35][r36];
                        eng6 = "they " + "don't " + vib[rand] + diespecial[r35][r36];
                        sp7 = "nosotros " + "no " + vibnos[rand] + morllorarSpecial[r35][r36];
            ...
            case "stay ":
                switch (neg) {
                    case 0:
                        ...
                        sp3 = "él " + vib3esp[rand] + quedspecial[r37][r38];
                        eng3 = "he " + vib3p[rand] + stayspecial[r37][r38];
                        sp4 = "ella " + vib3esp[rand] + quedspecial[r37][r38];
                        eng4 = "she " + vib3p[rand] + stayspecial[r37][r38];
                        sp5 = "eso " + vib3esp[rand] + quedspecial[r37][r38];
                    ...
                    case 1:
                        ...
                        sp3 = "él " + "no " + vib3esp[rand] + quedspecial[r37][r38];
                        eng3 = "he " + "doesn't " + vib[rand] + stayspecial[r37][r38];
                        sp4 = "ella " + "no " + vib3esp[rand] + quedspecial[r37][r38];
                        eng4 = "she " + "doesn't " + vib[rand] + stayspecial[r37][r38];
                        sp5 = "eso " + "no " + vib3esp[rand] + quedspecial[r37][r38];
            ...
            if (verbs.equals(temp)) {
                switch (neg) {
                    case 0:
                        ...
                        sp6 = "ellos " + "son capaces de " + vibesp[rand] + arrayEsp + advfrequ[radv];
                        eng6 = "they are " + "able to " + vib[rand] + arrayEng + frequadv[radv];
                        eng62 = "they're " + "able to " + vib[rand] + arrayEng + frequadv[radv];

                        sp7 = "nosotros " + "somos capaces de " + vibesp[rand] + arrayEsp + advfrequ[radv];
                    ...
                    case 1:
                        ...
                        sp6 = "ellos no " + "son capaces de " + vibesp[rand] + arrayEsp + advfrequ[radv];
                        eng6 = "they are not " + "able to " + vib[rand] + arrayEng + frequadv[radv];
                        eng62 = "they're not " + "able to " + vib[rand] + arrayEng + frequadv[radv];

                        sp7 = "nosotros no " + "somos capaces de " + vibesp[rand] + arrayEsp + advfrequ[radv];
