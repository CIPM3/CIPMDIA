    ...
    public void GenMustSimp4(){
        ...
        switch (negg) {
            ...
            case 1:
                ...
                ps1eng = "I " + "musn't "  + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I " + "musn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú " + "no debes "  + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you " + "musn't "  + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you " + "musn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él " + "no debe "  + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he " + "musn't "  + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he " + "musn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella " + "no debe "  + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she " + "musn't "  + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she " + "musn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3eso = "eso " + "no debe "  + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3it = "it " + "musn't "  + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3iteng2 = "it " + "musn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps4 = "ellos " + "no deben "  + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps4eng = "they " + "musn't "  + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they " + "musn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros " + "no debemos "  + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we " + "musn't "  + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we " + "musn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                break;
        }
    }// nuevo
    public void GenMustCont4(){
        ...
        switch (negg) {
            ...
            case 1:
                ...
                ps1eng = "I musn't "  + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I musn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú no debes "  + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you musn't "  + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you musn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él no debe "  + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he musn't "  + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he musn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella no debe "  + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she musn't "  + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she musn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3eso = "eso no debe "  + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3it = "it musn't "  + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3iteng2 = "it musn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps4 = "ellos no deben "  + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps4eng = "they musn't "  + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they musn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros no debemos "  + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we musn't "  + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we musn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
