    ...
    public void GenPastPerf2() {
        switch (neg) {
            case 0:
                ...
                ps3it2 = "it " + "had " + vpeng[v] + nnobles[n];
...
//these should go right after the subject
    ...
    public void GenPastCont3() {
        switch (negg) {
            ...
            case 1:
                ...
                ps2eng = "you were not " + vnbc[v] + nnobles[n] + frequadv[r];
    ...
    public void GenWouldCont3() {
        switch (negg) {
            ...
            case 1:
                ...
                ps1eng = "I would not " + "be " + vnbc[v] + nnobles[n] + frequadv[r];
    ...
    public void GenMightPerfCont3() {
        switch (negg) {
            ...
            case 1:
                ...
                ps4eng2 = "they mightn't " + "have been " + vnbc[v] + nnobles[n] + frequadv[r];
                ...
                ps5eng2 = "we mightn't " + "have been " + vnbc[v] + nnobles[n] + frequadv[r];
   ...
   // quité there be y causativos
    ...
    public void GenPresSimp4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo " + vn1[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps1eng = "I " + vnb[v] + nnobles[n]+prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps1eng2 = "I " + vnb[v] + nnobles[n] +prep.Oospecialeng[p][p2] + frequadv[r];

                ps2 = "tú " + vn2[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps2eng = "you " + vnb[v] + nnobles[n]+prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps2eng2 = "you " + vnb[v] + nnobles[n] +prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps4eng2 = "they " + vnb[v] + nnobles[n] +prep.Oospecialeng[p][p2] + frequadv[r];

                ps5 = "nosotros " + vn5[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps5eng = "we " + vnb[v] + nnobles[n]+prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps5eng2 = "we " + vnb[v] + nnobles[n] +prep.Oospecialeng[p][p2] + frequadv[r];

                break;
            case 1:
                ps1 = "yo " + "no " + vn1[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps1eng = "I " + "don't " + vnb[v] + nnobles[n]+prep.Oospecial[p][p2] + frequadv[r] ;
                ps1eng2 = "I " + "don't " + vnb[v] + nnobles[n] +prep.Oospecial[p][p2] + frequadv[r];

                ps2 = "tú " + "no " + vn2[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps2eng = "you " + "don't " + vnb[v] + nnobles[n]+prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps2eng2 = "you " + "don't " + vnb[v] + nnobles[n] +prep.Oospecialeng[p][p2] + frequadv[r];

                ps3 = "él " + "no " + vnb3[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3eng = "he " + "doesn't " + vnb[v] + nnobles[n]+prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps3eng2 = "he " + "doesn't " + vnb[v] + nnobles[n] +prep.Oospecialeng[p][p2] + frequadv[r];

                ps3ella = "ella " + "no " + vnb3[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3she = "she " + "doesn't " + vnb[v] + nnobles[n]+prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps3she2 = "she " + "doesn't " + vnb[v] + nnobles[n] +prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps4eng2 = "they " + "don't " + vnb[v] + nnobles[n] +prep.Oospecialeng[p][p2] + frequadv[r];

                ps5 = "nosotros " + "no " + vn5[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps5eng = "we " + "don't " + vnb[v] + nnobles[n]+prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps5eng2 = "we " + "don't " + vnb[v] + nnobles[n] +prep.Oospecialeng[p][p2] + frequadv[r];
    ...
    public void GenPresCont4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo " + "estoy " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps1eng = "I am " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps1eng2 = "I'm " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps2 = "tú " + "estás " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps2eng = "you are " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps2eng2 = "you're " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps3 = "él " + "está " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[r];
                ps3eng = "he is " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + advfrequ[r];
                ps3eng2 = "he's " + vnbc[v] + nnobles[n]  + prep.Oospecialeng[p][p2] + advfrequ[r];

                ps3ella = "ella " + "está " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[r];
                ps3she = "she is " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + advfrequ[r];
                ps3she2 = "she's " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + advfrequ[r];
                ...
                ps3it2 = "it's " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + advfrequ[r];
                ...
                ps4eng2 = "they're " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + advfrequ[r];

                ps5 = "nosotros " + "estamos " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[r];
                ps5eng = "we are " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + advfrequ[r];
                ps5eng2 = "we're " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + advfrequ[r];

                break;
            case 1:
                ps1 = "yo no " + "estoy " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps1eng = "I am not " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps1eng2 = "I'm not " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps2 = "tú no " + "estás " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps2eng = "you're not " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps2eng2 = "you aren't " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps3 = "él no " + "está " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3eng = "he's not " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps3eng2 = "he isn't " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps3ella = "ella no " + "está " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3she = "she's not " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps3she2 = "she isn't " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps3eso = "eso no " + "está " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3it = "it's not " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r] ;
                ...
                ps4eng = "they're not " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps4eng2 = "they aren't " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps5 = "nosotros no " + "estamos " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps5eng = "we're not " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps5eng2 = "we aren't " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
    ...
    public void GenPresPerf4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo " + "he " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps1eng = "I have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps1eng2 = "I've " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps2 = "tú " + "has " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps2eng = "you have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps2eng2 = "you've " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps3 = "él " + "ha " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3eng = "he has " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3eng2 = "he's " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps3ella = "ella " + "ha " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3she = "she has " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3she2 = "she's " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps3it2 = "it's " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps4eng2 = "they've " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps5 = "nosotros " + "hemos " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps5eng = "we have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps5eng2 = "we've " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                break;
            case 1:

                ps1 = "yo no " + "he " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r] ;
                ps1eng = "I have not " + vpeng[v] + nnobles[n]+prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps1eng2 = "I haven't " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r] ;

                ps2 = "tú no " + "has " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r] ;
                ps2eng = "you have not " + vpeng[v] + nnobles[n]+prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps2eng2 = "you haven't " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r] ;

                ps3 = "él no " + "ha " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r] ;
                ps3eng = "he has not " + vpeng[v] + nnobles[n]+prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps3eng2 = "he hasn't " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r] ;

                ps3ella = "ella no " + "ha " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r] ;
                ps3she = "she has not " + vpeng[v] + nnobles[n]+prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps3she2 = "she hasn't " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r] ;

                ps3eso = "eso no " + "ha " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r] ;
                ps3it = "it has not " + vpeng[v] + nnobles[n]+prep.Oospecialeng[p][p2] + frequadv[r] ;
                ...
                ps4eng = "they have not " + vpeng[v] + nnobles[n]+prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps4eng2 = "they haven't " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r] ;


                ps5 = "nosotros no " + "hemos " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r] ;
                ps5eng = "we have not " + vpeng[v] + nnobles[n]+prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps5eng2 = "we haven't " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r] ;
    ...
    public void GenPresPerfCont4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo " + "he estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps1eng = "I have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps1eng2 = "I have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps2 = "tú " + "has estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps2eng = "you have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps2eng2 = "you have " + "been " + vnbc[v] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps3 = "él " + "ha estdo " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3eng = "he has " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3eng2 = "he has " + "been " + vnbc[v] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps3ella = "ella " + "ha estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3she = "she has " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3eng2 = "she has " + "been " + vnbc[v] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps4eng2 = "they have " + "been " + vnbc[v] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps5 = "nosotros " + "hemos estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps5eng = "we have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps5eng2 = "we have " + "been " + vnbc[v] + prep.Oospecialeng[p][p2] + frequadv[r];

                break;
            case 1:
                ps1 = "yo no " + "he estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps1eng = "I haven't " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps1eng2 = "I haven't " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps2 = "tú no " + "has estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps2eng = "you haven't " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps2eng2 = "you haven't " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps3 = "él no " + "ha estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3eng = "he hasn't " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3eng2 = "he hasn't " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps3ella = "ella no " + "ha estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3she = "she hasn't " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3she2 = "she hasn't " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps4eng2 = "they haven't " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps5 = "nosotros no " + "hemos estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps5eng = "we haven't " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps5eng2 = "we haven't " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                break;
        }
    ...
    public void GenPastSimp4() {
        ...
        switch (neg) {
            case 1:
                if (sr == 0) {
                    ps1 = "yo " + ps1pre[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                    ps1eng = "I " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                    ps1eng2 = "I " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                    ps2 = "tú " + ps2pre[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[r];
                    ps2eng = "you " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                    ps2eng2 = "you " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                    ps3 = "él " + ps3p[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                    ps3eng = "he " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                    ps3eng2 = "he " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                    ps3ella = "ella " + ps3p[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                    ps3she = "she " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                    ps3she = "she " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                    ps3eso = "eso " + ps3p[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                    ps3it = "it " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                    ps3it = "it " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                    ps4 = "ellos " + vn4p[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                    ps4eng = "they " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                    ps4eng = "they " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                    ps5 = "nosotros " + vn5p[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                    ps5eng = "we " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                    ps5eng = "we " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                } else {
                    ps1 = "yo " + ps1imp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                    ps1eng = "I " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                    ps1eng = "I " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                    ps2 = "tú " + ps2imp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                    ps2eng = "you " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                    ps2eng = "you " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                    ps3 = "él " + ps3imp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r] ;
                    ps3eng = "he " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                    ps3eng = "he " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                    ps3ella = "ella " + ps3imp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                    ps3she = "she " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                    ps3eso = "eso " + ps3imp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                    ps3it = "it " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                    ps4 = "ellos " + vn4imp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                    ps4eng = "they " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                    ps5 = "nosotros " + vn5imp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                    ps5eng = "we " + vnbp[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                }
                break;
    ...
    public void GenPastCont4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo " + "estaba " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps1eng = "I was " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps1eng2 = "I was " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps2 = "tú " + "estabas " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps2eng = "you were " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps2eng2 = "you were " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps3 = "él " + "estaba " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3eng = "he was " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3eng2 = "he was " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps3ella = "ella " + "estaba " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3she = "she was " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3she2 = "she was " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps4eng = "they were " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps4eng2 = "they were " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps5 = "nosotros " + "estábamos " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps5eng = "we were " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps5eng2 = "we were " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                break;
            case 1:
                ps1 = "yo no " + "estaba " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps1eng = "I was not " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps1eng2 = "I wasn't " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps2 = "tú no " + "estabas " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps2eng = "you were not " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps2eng2 = "you weren't " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps3 = "él no " + "estaba " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3eng = "he was not " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3eng2 = "he wasn't " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps3ella = "ella no " + "estaba " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3she = "she was not " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3she2 = "she wasn't " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps3eso = "eso no " + "estaba " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3it = "it was not " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r] ;
                ...
                ps4eng = "they were not " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps4eng2 = "they weren't " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps5 = "nosotros no " + "estábamos " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps5eng = "we were not " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps5eng2 = "we weren't " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
    ...
    public void GenPastPerf4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps1eng2 = "I'd " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps2eng2 = "you'd " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps3eng2 = "he'd " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps3she2 = "she'd " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps3it2 = "it'd " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps4eng2 = "they'd " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps5eng2 = "we'd " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                break;
            case 1:
                ps1 = "yo no " + "había " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps1eng = "I had not " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps2eng = "you had not " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps3eng = "he had not " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps3she = "she had not " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps3it = "it had not " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps4eng = "they had not " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps5eng = "we had not " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
    ...
    public void GenPastPerfCont4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo " + "había estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps1eng = "I had " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps1eng2 = "I had " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps2 = "tú " + "habías estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps2eng = "you had " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps2eng2 = "you had " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps3 = "él " + "había estdo " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3eng = "he had " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3eng2 = "he had " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps3ella = "ella " + "había estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3she = "she had " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3she2 = "she had " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps4eng = "they had " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps4eng2 = "they had " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps5 = "nosotros " + "habíamos estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps5eng = "we had " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps5eng2 = "we had " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                break;
            case 1:
                ps1 = "yo no " + "había estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps1eng = "I hadn't " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps1eng2 = "I hadn't " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps2 = "tú no " + "habías estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps2eng = "you hadn't " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps2eng2 = "you hadn't " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps3 = "él no " + "había estdo " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3eng = "he hadn't " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3eng2 = "he hadn't " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps3ella = "ella no " + "había estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3she = "she hadn't " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3she2 = "she hadn't " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps4eng2 = "they hadn't " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps5 = "nosotros no " + "habíamos estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps5eng = "we hadn't " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps5eng2 = "we hadn't " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
    ...
    public void GenFutSimp4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo " + vn1f[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps1eng = "I will " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps1eng2 = "I will " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps2 = "tú " + vn2f[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps2eng = "you will " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps2eng2 = "you will " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps3 = "él " + vn3f[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3eng = "he will " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3eng2 = "he will " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps3ella = "ella " + vn3f[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3she = "she will " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3she2 = "she will " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps4eng = "they will " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps4eng2 = "they will " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps5 = "nosotros " + vn5f[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps5eng = "we will " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps5eng2 = "we will " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                break;
            case 1:
                ps1 = "yo " + "no " + vn1f[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps1eng = "I " + "won't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps1eng2 = "I " + "won't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps2 = "tú " + "no " + vn2f[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps2eng = "you " + "won't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps2eng2 = "you " + "won't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps3 = "él " + "no " + vn3f[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3eng = "he " + "won't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3eng2 = "he " + "won't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps3ella = "ella " + "no " + vn3f[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3she = "she " + "won't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3she2 = "she " + "won't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps4eng = "they " + "won't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps4eng2 = "they " + "won't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps5 = "nosotros " + "no " + vn5f[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps5eng = "we " + "won't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps5eng2 = "we " + "won't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
    ...
    public void GenFutCont4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo " + "estaré " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps1eng = "I will " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps1eng2 = "I'll " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r] ;

                ps2 = "tú " + "estarás " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps2eng = "you will " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps2eng2 = "you'll " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps3 = "él " + "estará " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3eng = "he will " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3eng2 = "he'll " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps3ella = "ella " + "estará " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3she = "she will " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3she2 = "she'll " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps3it2 = "it'll " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps4 = "ellos " + "estarán " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps4eng = "they will " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps4eng2 = "they'll " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps5 = "nosotros " + "estaremos " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps5eng = "we will " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps5eng2 = "we'll " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                break;
            case 1:
                ps1 = "yo no " + "estaré " + vnbcs[v] + nnoblesesp[n]  + prep.Oospecial[p][p2] + advfrequ[r];
                ps1eng = "I will not " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps1eng2 = "I won't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps2 = "tú no " + "estarás " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps2eng = "you will not " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps2eng2 = "you won't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                ps3 = "él no " + "estará " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3eng = "he will not " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3eng2 = "he won't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps3ella = "ella no " + "estará " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3she = "she will not " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3she2 = "she won't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps3eso = "eso no " + "estará " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3it = "it will not " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps4eng = "they will not " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps4eng2 = "they won't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps5 = "nosotros no " + "estaremos " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps5eng = "we will not " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps5eng2 = "we won't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
    ...
    public void GenFutPerf4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo " + "habré " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps1eng = "I will " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps1eng2 = "I'll " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps2 = "tú " + "habrás " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps2eng = "you will " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps2eng2 = "you'll " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps3 = "él " + "habrá " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3eng = "he will " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3eng2 = "he'll " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps3ella = "ella " + "habrá " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3she = "she will " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3she2 = "she'll " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps3it2 = "it'll " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps4 = "ellos " + "habrán " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps4eng = "they will " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps4eng2 = "they'll " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps5 = "nosotros " + "habremos " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps5eng = "we will " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps5eng2 = "we'll " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];

                break;
            case 1:
                ps1 = "yo no " + "habré " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps1eng = "I will not " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[r];
                ps1eng2 = "I won't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps2 = "tú no " + "habrás " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps2eng = "you will not " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps2eng2 = "you won't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps3 = "él no " + "habrá " + vpsp[v] + nnoblesesp[n]  + prep.Oospecial[p][p2] + advfrequ[r];
                ps3eng = "he will not " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3eng2 = "he won't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps3ella = "ella no " + "habrá " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3she = "she will not " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps3she2 = "she won't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps3eso = "eso no " + "habrá " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3it = "it will not " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps4eng = "they will not " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps4eng2 = "they won't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps5 = "nosotros no " + "habremos " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps5eng = "we will not " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps5eng2 = "we won't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
    ...
    public void GenFutPerfCont4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo " + "habré estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps1eng = "I will have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps1eng2 = "I will have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps2 = "tú " + "habrás estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps2eng = "you will have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[r];
                ps2eng2 = "you will have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps3 = "él " + "habrá estdo " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3eng = "he will have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[r];
                ps3eng2 = "he will have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps3ella = "ella " + "habrá estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3she = "she will have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[r];
                ps3she2 = "she will have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps4eng = "they will have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[r];
                ps4eng2 = "they will have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps5 = "nosotros " + "habremos estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps5eng = "we will have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[r];
                ps5eng2 = "we will have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                break;
            case 1:
                ps1 = "yo no " + "habré estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps1eng = "I won't have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[r] ;
                ps1eng2 = "I won't have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps2 = "tú no " + "habrás estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps2eng = "you won't have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps2eng2 = "you won't have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps3 = "él no " + "habrá estdo " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3eng = "he won't have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3eng2 = "he won't have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps3ella = "ella no " + "habrá estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps3she = "she won't have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps3she2 = "she won't have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ...
                ps4eng = "they won't have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps4eng2 = "they won't have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];


                ps5 = "nosotros no " + "habremos estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[r];
                ps5eng = "we won't have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
                ps5eng2 = "we won't have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[r];
    ...
    public void GenWouldSimp4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo " + vn1w[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I would " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I would " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú " + vn2w[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you would " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you would " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él " + vn3w[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he would " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he would " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps3ella = "ella " + vn3w[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she would " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she would " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng2 = "they would " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps5 = "nosotros " + vn5w[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we would " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng = "we would " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                break;
            case 1:
                ps1 = "yo " + "no " + vn1w[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I " + "wouldn't " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I " + "wouldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú " + "no " + vn2w[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you " + "wouldn't " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you " + "wouldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él " + "no " + vn3w[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he " + "wouldn't " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he " + "wouldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella " + "no " + vn3w[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she " + "wouldn't " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she " + "wouldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they " + "wouldn't " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they " + "wouldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros " + "no " + vn5w[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we " + "wouldn't " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we " + "wouldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void GenWouldCont4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo " + "estaría " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I would " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I'd " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps2 = "tú " + "estarías " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you would " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you'd " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps3 = "él " + "estaría " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he would " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he'd " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps3ella = "ella " + "estaría " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she would " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she'd " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps3it2 = "it'd " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng2 = "they'd " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps5 = "nosotros " + "estaríamos " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we would " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we'd " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                break;
            case 1:
                ps1 = "yo no " + "estaría " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I would not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I wouldn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú no " + "estarías " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you would not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you wouldn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él no " + "estaría " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he would not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he wouldn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella no " + "estaría " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she would not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she wouldn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3eso = "eso no " + "estaría " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3it = "it would not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they would not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they wouldn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps5 = "nosotros no " + "estaríamos " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we would not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we wouldn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void GenWouldPerf4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo " + "hubiera " + vpsp[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I would " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I'd " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú " + "hubieras " + vpsp[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you would " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you'd " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él " + "hubiera " + vpsp[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he would " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he'd " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella " + "hubiera " + vpsp[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she would " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she'd " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps3it2 = "it'd " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps4 = "ellos " + "hubieran " + vpsp[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps4eng = "they would " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they'd " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros " + "hubieramos " + vpsp[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we would " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we'd " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                break;
            case 1:
                ps1 = "yo no " + "hubiera " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I would not " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I wouldn't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú no " + "hubieras " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you would not " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you wouldn't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él no " + "hubiera " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he would not " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he wouldn't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella no " + "hubiera " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she would not " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she wouldn't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3eso = "eso no " + "hubiera " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3it = "it would not " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they would not " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they wouldn't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros no " + "hubieramos " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we would not " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we wouldn't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void GenWouldPerfCont4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo " + "hubiera estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I would have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I would have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú " + "hubieras estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you would have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you would have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él " + "hubiera estdo " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he would have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he would have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella " + "hubiera estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she would have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she would have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they would have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they would have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros " + "hubieramos estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we would have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we would have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                break;
            case 1:
                ps1 = "yo no " + "hubiera estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I wouldn't have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I wouldn't have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú no " + "hubieras estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you wouldn't have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you wouldn't have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él no " + "hubiera estdo " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv]; ;
                ps3eng = "he wouldn't have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he wouldn't have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella no " + "hubiera estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv]; ;
                ps3she = "she wouldn't have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she wouldn't have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they wouldn't have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they wouldn't have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros no " + "hubieramos estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv]; ;
                ps5eng = "we wouldn't have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we wouldn't have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void GenCouldSimp4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo podría " + vnbs[v] + nnoblesesp[n]  + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I could " + vnb[v] + nnobles[n]  + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I could " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú podrías " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you could " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you could " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él podría " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he could " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he could " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella podría " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she could " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she could " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they could " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they could " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros podríamos " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we could " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we could " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                break;
            case 1:
                ps1 = "yo " + "no podría " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I " + "couldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I " + "couldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú " + "no podrías " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you " + "couldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you " + "couldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él " + "no podría " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he " + "couldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he " + "couldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella " + "no podría " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she " + "couldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she " + "couldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they " + "couldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they " + "couldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros " + "no podríamos " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we " + "couldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we " + "couldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void GenCouldCont4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo podría " + "estar " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I could " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I could " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú podrías " + "estar " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you could " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you could " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él podría " + "estar " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he could " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he could " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella podría " + "estar " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she could " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she could " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they could " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they could " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros podríamos " + "estar " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we could " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we could " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                break;
            case 1:
                ps1 = "yo no podría " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I could not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I couldn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú no podrías " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you could not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you couldn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él no podría " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he could not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he couldn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella no podría " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she could not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she couldn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3eso = "eso no podría " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3it = "it could not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they could not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they couldn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros no podríamos " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we could not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we couldn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void GenCouldPerf4() {
        ...
        switch (negg) {
            case 0:
                ...
                break;
            case 1:
                ps1 = "yo no pude " + "haber " + vpsp[v] + nnoblesesp[n]  + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I could not " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I couldn't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú no pudiste " + "haber " + vpsp[v] + nnoblesesp[n]  + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you could not " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you couldn't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps3 = "él no pudo " + "haber " + vpsp[v] + nnoblesesp[n]  + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he could not " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he couldn't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella no pudo " + "haber " + vpsp[v] + nnoblesesp[n]  + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she could not " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she couldn't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3eso = "eso no pudo " + "haber " + vpsp[v] + nnoblesesp[n]  + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3it = "it could not " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they could not " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they couldn't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros no pudimos " + "haber " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we could not " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we couldn't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void GenCouldPerfCont4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo " + "pude haber estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I could have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I could have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú " + "pudiste haber estado " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you could have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you could have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él " + "pudo haber estado " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he could have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he could have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella " + "pudo haber estado " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she could have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she could have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they could have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they could have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros " + "pudimos haber estado " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we could have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we could have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                break;
            case 1:
                ps1 = "yo no " + "pude haber estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I couldn't " + "have been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I couldn't " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú no " + "pudiste haber estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you couldn't " + "have been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you couldn't " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él no " + "pudo haber estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he couldn't " + "have been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he couldn't " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella no " + "pudo haber estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she couldn't " + "have been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she couldn't " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "we couldn't " + "have been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "we couldn't " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros no " + "pudimos haber estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "they couldn't " + "have been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "they couldn't " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void GenShouldSimp4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo debería " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I should " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I should " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú deberías " + vnbs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you should " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you should " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él debería " + vnbs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he should " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he should " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella debería " + vnbs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she should " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she should " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they should " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they should " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros deberíamos " + vnbs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we should " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we should " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                break;
            case 1:
                ps1 = "yo " + "no debería " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I " + "shouldn't " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I " + "shouldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps2 = "tú " + "no deberías " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you " + "shouldn't " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you " + "shouldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps3 = "él " + "no debería " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he " + "shouldn't " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he " + "shouldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps3ella = "ella " + "no debería " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she " + "shouldn't " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she " + "shouldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng2 = "they " + "shouldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps5 = "nosotros " + "no deberíamos " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we " + "shouldn't " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we " + "shouldn't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                break;
        }
    } //SV 280422
    public void GenShouldCont4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo debería " + "estar " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I should " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I'd " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú deberías " + "estar " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you should " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you'd " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él debería " + "estar " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he should " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he'd " + "be " + vnbc[v] + prep.Oospecialeng[p][p2] + frequadv[radv]+ nnobles[n];


                ps3ella = "ella debería " + "estar " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she should " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she'd " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they should " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they'd " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros deberíamos " + "estar " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we should " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we'd " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                break;
            case 1:
                ps1 = "yo no debería " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I should not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I shouldn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú no deberías " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you should not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you shouldn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps3 = "él no debería " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he should not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he shouldn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps3ella = "ella no debería " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she should not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she shouldn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps3eso = "eso no debería " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3it = "it should not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they should not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they shouldn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps5 = "nosotros no deberíamos " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we should not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we shouldn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void GenShouldPerf4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo debí " + "haber " + vpsp[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I should " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I'd " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú debiste " + "haber " + vpsp[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you should " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you'd " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él debió " + "haber " + vpsp[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he should " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he'd " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella debió " + "haber " + vpsp[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she should " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she'd " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they should " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they'd " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                break;
            case 1:
                ps1 = "yo no debí " + "haber " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I should not " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I shouldn't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú no debiste " + "haber " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you should not " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you shouldn't " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él no debió " + "haber " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he should not " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he shouldn't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella no debió " + "haber " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she should not " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she shouldn't " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3eso = "eso no debió " + "haber " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3it = "it should not " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they should not " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they shouldn't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros no debimos " + "haber " + vpsp[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we should not " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we shouldn't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void GenShouldPerfCont4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo " + "debí haber estado " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I should have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I should have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú " + "debiste haber estado " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you should have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you should have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él " + "debió haber estado " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he should have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he should have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella " + "debió haber estado " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she should have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she should have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they should have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they should have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros " + "debimos haber estado " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we should have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we should have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                break;
            case 1:
                ps1 = "yo no " + "debí haber estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I shouldn't " + "have been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I shouldn't " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú no " + "debiste haber estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you shouldn't " + "have been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you shouldn't " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él no " + "debió haber estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he shouldn't " + "have been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he shouldn't " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella no " + "debió haber estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she shouldn't " + "have been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she shouldn't " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they shouldn't " + "have been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they shouldn't " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros no " + "debimos haber estado " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we shouldn't " + "have been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we shouldn't " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void GenMightSimp4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo quizá " + vn1y3subj[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I might " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I might " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú quizá " + vn2subj[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you might " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you might " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él quizá " + vn1y3subj[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he might " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he might " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella quizá " + vn1y3subj[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she might " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she might " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they might " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they might " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros quizá" + vn5subj[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we might " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we might " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                break;
            case 1:
                ps1 = "yo " + "quizá no " + vn1y3subj[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I " + "might not " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I " + "might not " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú " + "quizá no " + vn2subj[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you " + "might not " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you " + "might not " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él " + "quizá no " + vn1y3subj[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he " + "might not " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he " + "might not " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella " + "quizá no " + vn1y3subj[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she " + "might not " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she " + "might not " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they " + "might not " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they " + "might not " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros " + "quizá no " + vn5subj[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we " + "might not " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we " + "might not " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void GenMightCont4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo quizá " + "esté " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I might " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I might " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú quizá " + "estés " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you might " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you might " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él quizá " + "esté " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he might " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he might " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella quizá " + "esté " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she might " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she might " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they might " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they might " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros quizá " + "estemos " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we might " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we might " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                break;
            case 1:
                ps1 = "yo quizá no " + "esté " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I might not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I mightn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps2 = "tú quizá no " + "estés " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you might not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you mightn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps3 = "él quizá no " + "esté " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he might not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he mightn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella quizá no " + "esté " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she might not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she mightn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps3it2 = "it mightn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps4 = "ellos quizá no " + "estén " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps4eng = "they might not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they mightn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros quizá no " + "estemos " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we might not " + "be " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we mightn't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void GenMightPerf4() {
        ...
        switch (negg) {
            case 0:
                ...
                ps3she2 = "she might " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
            ...
            case 1:
                ...
                ps1eng2 = "I mightn't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú quizá no " + "hayas " + vpsp[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you might not " + "have " + vpeng[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you mightn't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps3eng2 = "he mightn't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps3she2 = "she mightn't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps3it2 = "it mightn't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng2 = "they mightn't " + "have " + vpeng[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros quizá no " + "hayamos " + vpsp[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
    ...
    public void GenMightPerfCont4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo quizá " + "haya estado " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I might have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I might have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú quizá " + "hayas estado " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you might have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you might have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él quizá " + "haya estado " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he might have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he might have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella quizá " + "haya estado " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she might have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she might have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they might have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they might have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros quizá " + "hayamos estado " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we might have " + "been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we might have " + "been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                break;

            case 1:
                ps1 = "yo quizá no " + "haya estado " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I might not " + "have been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I mightn't " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú quizá no " + "hayas estado " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you might not " + "have been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you mightn't " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él quizá no " + "haya estado " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he might not " + "have been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he mightn't " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella quizá no " + "haya estado " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she might not " + "have been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she mightn't " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps3it2 = "it mightn't " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps4 = "ellos quizá no " + "hayan estado " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps4eng = "they might not " + "have been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they mightn't " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros quizá no " + "hayamos estado " + vnbcs[v] + nnoblesesp[n]+ prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we might not " + "have been " + vnbc[v] + nnobles[n]+ prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we mightn't " + "have been " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void GenCanSimp4() {
        ...
        switch (negg) {
            case 0:
                ps1 = "yo puedo " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I can " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I can " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps2 = "tú puedes " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you can " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you can " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él puede " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he can " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he can " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella puede " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she can " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she can " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they can " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they can " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros podemos " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we can " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng = "we can " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                break;
            case 1:
                ps1 = "yo " + "no puedo " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I " + "can't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I " + "can't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú " + "no puedes " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you " + "can't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you " + "can't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él " + "no puede " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he " + "can't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he " + "can't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella " + "no puede " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she " + "can't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she " + "can't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they " + "can't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they " + "can't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros " + "no podemos " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we " + "can't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we " + "can't " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void GenCanCont4(){
        ...
        switch (negg) {
            case 0:
                ps1 = "yo puedo " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I can " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I can " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú puedes " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you can " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you can " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él puede " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he can " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he can " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella puede " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she can " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she can " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they can " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they can " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros podemos " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we can " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we can " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                break;
            case 1:
                ps1 = "yo no puedo " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I cannot " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I can't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú no puedes " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you cannot " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you can't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él no puede " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he cannot " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he can't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella no puede " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she cannot " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she can't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3eso = "eso no puede " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3it = "it cannot " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they cannot " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they can't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros no podemos " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we cannot " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we can't " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void GenMustSimp4(){
        ...
        switch (negg) {
            case 0:
                ps1 = "yo debo " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I must " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I must " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú debes " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you must " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you must " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él debe " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he must " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he must " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella debe " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she must " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she must " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they must " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they must " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros debemos " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we must " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we must " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void GenMustCont4(){
        ...
        switch (negg) {
            case 0:
                ps1 = "yo debo " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps1eng = "I must " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps1eng2 = "I must " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps2 = "tú debes " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps2eng = "you must " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps2eng2 = "you must " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3 = "él debe " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he must " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3eng2 = "he must " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps3ella = "ella debe " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3she = "she must " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps3she2 = "she must " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps4eng = "they must " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps4eng2 = "they must " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];


                ps5 = "nosotros debemos " + "estar " + vnbcs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "we must " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ps5eng2 = "we must " + "be " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void supposedtopres4() {
        ...
        switch (vc) {
            case 0:
                ...
                ps2eng = "you are supposed to " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps3 = "Se supone que él " + vnb3[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps3eng = "he is supposed to " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps5eng = "we are supposed to " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                break;
            case 1:
                ...
                ps5eng = "we aren't supposed to " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                break;
    ...
    public void supposedtopast4() {
        ...
        switch (neg) {
            case 0:
                ...
                ps3eng = "he was supposed to " + vnb[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
    ...
    public void BeUsedToDif4() {
        ...
        switch (neg) {
            case 0:
                ...
                ps2eng = "You are used to " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps3it = "It is used to " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps4 = "Ellos están acostumbrados a " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps4eng = "They are used to " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps5 = "Nosotros estamos acostumbrados a " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "We are used to " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                break;
            ...
            case 1:
                ...
                ps2eng = "You aren't used to " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                ...
                ps3it = "It isn't used to " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps4 = "Ellos no están acostumbrados a " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps4eng = "They aren't used to " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];

                ps5 = "Nosotros no estamos acostumbrados a " + vnbs[v] + nnoblesesp[n] + prep.Oospecial[p][p2] + advfrequ[radv];
                ps5eng = "We aren't used to " + vnbc[v] + nnobles[n] + prep.Oospecialeng[p][p2] + frequadv[radv];
                break;
        }
    } //PD 29/04/2022
    ...
    public void intporprepps0a100(){
        ...
        switch (neg) {
            case 0:
                ...
                ps3 =prep.Oospecial[p][p2] + vnb3[v] + nnoblesesp[n];
                ps3eng = "he " + vn3[v] + nnobles[n]+prep.Oospecialeng[p][p2];

                ps3ella = prep.Oospecial[p][p2] + vnb3[v] + nnoblesesp[n];
                ps3she = "she " + vn3[v] + nnobles[n]+prep.Oospecialeng[p][p2];

                ps3eso = prep.Oospecial[p][p2] +vnb3[v] + nnoblesesp[n];
    ...
    public void intporpasiva0a100(){
        ...
        switch (neg) {
            case 0:
                ...
                ps5eng="we " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2];
                ps6eng = nnobles[n] + "gets " + vpeng[v]+ prep.Oospecialeng[p][p2];
            ...
            case 1 :
                ...
                ps5eng="we don't " + vnb[v] + nnobles[n]+ prep.Oospecialeng[p][p2];
                ps6eng = nnobles[n] + "doesn't get " + vpeng[v]+ prep.Oospecialeng[p][p2];
                break;
